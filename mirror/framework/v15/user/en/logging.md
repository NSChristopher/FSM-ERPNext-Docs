---
title: "Logging"
source_url: https://docs.frappe.io/framework/v15/user/en/logging
...
Logs that can be accessed via the Desk UI _(generally searched for, from the_ [_Awesomebar_](https://docs.frappe.io/framework/v14/user/en/desk#awesomebar)_)_. These track the operational events generally; but you can utilize their APIs to track about anything from your Frappe apps.
...
Tracking the bench commands executed, status of the jobs run by your Scheduler or [Background Jobs](https://docs.frappe.io/framework/v14/user/en/guides/app-development/running-background-jobs) can be found in these logs.
...
Form Dict: {'docs': '{"name":"assets.frappeframework.com","owner":"Administrator","creation":"2020-04-04 14:58:18.771247","modified":"2021-02-08 09:40:56.820300","modified_by":"[email protected]","idx":0,"docstatus":0,"status":"Active","hostname":"assets","domain":"frappeframework.com","cluster":"Default","provider":"Generic","is_server_setup":1,"ip":"192.168.29.100","private_ip":"10.120.120.120","agent_password":"*****","is_primary":1,"doctype":"Server","__last_sync_on":"2021-05-06T08:38:08.931Z"}', 'method': 'ping_agent', 'cmd': 'run_doc_method'}
```
...
Server Logs may be generated by the [bench CLI](https://docs.frappe.io/framework/v14/user/en/bench), your process manager or the Frappe application directly. Your process managers take care of getting all the moving parts up and running for your Frappe environment as well as directing output and error streams to your log files.

Apart from the _"always running"_ default logging, you can also use [Monitor](https://docs.frappe.io/framework/v14/user/en/debugging#monitoring) to log more information about all the requests to your site.
...
![Log Settings](https://docs.frappe.io/files/log_settings.png)
...
-   [Frappe Logging API](https://docs.frappe.io/framework/v14/user/en/api/logging)
