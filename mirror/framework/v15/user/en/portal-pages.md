---
title: "Portal Pages"
source_url: https://docs.frappe.io/framework/v15/user/en/portal-pages
...
[Desk](https://docs.frappe.io/framework/v14/user/en/desk) which is an SPA but also static server rendered web  
...
> [API](https://docs.frappe.io/framework/v14/user/en/api/jinja) to use in jinja templates.
