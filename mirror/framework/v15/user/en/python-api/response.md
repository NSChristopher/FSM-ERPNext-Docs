---
title: "Responses"
source_url: https://docs.frappe.io/framework/v15/user/en/python-api/response
...
Documentation](https://docs.frappe.io/framework/v14/user/en/python-api/routing-and-rendering), you might've noticed the  
