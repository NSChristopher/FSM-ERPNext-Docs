---
title: "Search"
source_url: https://docs.frappe.io/framework/v15/user/en/python-api/search
...
You can search the index using the `search` method of the FTS class. These functions are documented in the API reference [here](https://docs.frappe.io/framework/v14/user/en/api/full-text-search).
