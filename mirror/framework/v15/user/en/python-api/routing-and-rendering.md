...
source_url: https://docs.frappe.io/framework/v15/user/en/python-api/routing-and-rendering
...
Learn more about [API requests](https://docs.frappe.io/framework/v14/user/en/api/rest) and [Static Files](https://docs.frappe.io/framework/v14/user/en/basics/static-assets) in detail.
...
Path resolver tries to resolve any possible redirect for an incoming request path. Path resolver gets redirect rules for [`website_redirects` hook](https://docs.frappe.io/framework/v14/user/en/python-api/hooks#website-redirects) and route redirects from website settings.
