...
source_url: https://docs.frappe.io/framework/v15/user/en/basics
...
![List View](https://docs.frappe.io/files/list-view.png) _List View_

The Form View used for editing records also supports file attachments, PDF format, comments, email, etc.

![Form View](https://docs.frappe.io/files/form-view.png) _Form View_

The Report Builder supports adding columns, grouping, filtering, sorting and saving it as a configuration.

![Report Builder](https://docs.frappe.io/files/report-builder.png) _Report Builder_
...
![Print Preview](https://docs.frappe.io/files/print-view.png) _Print Preview_

![Print Format Builder](https://docs.frappe.io/files/print-format-builder.png) _Print Format Builder_
