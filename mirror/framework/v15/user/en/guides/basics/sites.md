---
title: "Sites"
source_url: https://docs.frappe.io/framework/v15/user/en/guides/basics/sites
...
[Frappe Apps](https://docs.frappe.io/framework/v14/user/en/basics/apps).
...
-   `locks` directory is used by the scheduler to synchronize various jobs using  
    the [file locking concept](https://en.wikipedia.org/wiki/File_locking).
...
[See configuration options for `site_config.json`](https://docs.frappe.io/framework/v14/user/en/basics/sites#site-config)
