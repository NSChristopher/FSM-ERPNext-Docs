---
title: "Google GSuite"
source_url: https://docs.frappe.io/framework/v15/user/en/guides/integration/google_gsuite
...
For Example,  
If this document will be used to employee and the Doctype has the field _**name**_ then you can use it in Google Docs ad `{{name}}`
