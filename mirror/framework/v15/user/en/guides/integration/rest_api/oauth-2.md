---
title: "OAuth 2"
source_url: https://docs.frappe.io/framework/v15/user/en/guides/integration/rest_api/oauth-2
...
{'sub': '1234567890', 'name': 'J. Doe', 'email': '[email protected]', 'iat': 1516239022, 'exp': 1516242022, 'aud': 'client_id', 'roles': ['System Manager', 'Sales Manager'], 'nonce': '789123', 'iss': 'https://erp.example.com'}
```
...
-   Raffael Meyer ([\[email protected\]](https://docs.frappe.io/cdn-cgi/l/email-protection))
-   Revant Nandgaonkar ([\[email protected\]](https://docs.frappe.io/cdn-cgi/l/email-protection))
