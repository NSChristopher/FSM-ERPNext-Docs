...
source_url: https://docs.frappe.io/framework/v15/user/en/guides/app-development/how-to-improve-a-standard-control
...
Look the highlighted sections in the **goal**, we have _many translations_ to add in _many records_ and in _many doctypes_, so, we heave a **many of work**, so we have a lot to do right?
