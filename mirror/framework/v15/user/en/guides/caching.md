---
title: "Caching"
source_url: https://docs.frappe.io/framework/v15/user/en/guides/caching
...
In [2]: frappe.cache.hset("user|admin", "email", "[email protected]")
...
Out[4]: {'name': 'Admin', 'email': '[email protected]'}
```
...
Refer to the official config documentation to understand more: <https://redis.io/docs/latest/operate/oss\_and\_stack/management/config-file/>
