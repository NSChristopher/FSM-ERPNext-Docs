---
title: "Blog Post"
source_url: https://docs.frappe.io/framework/v15/user/en/blog-post
...
![Blog Post in Markdown](https://docs.frappe.io/files/v-14-blog-post-in-markdown.png)  
_Blog Post in Markdown_

View your Blog Post by clicking on **See on Website** in the sidebar.  
![Blog Post](https://docs.frappe.io/files/blog-post.png)  
_Blog Post_

Readers can comment on the blog post. The guest user will have to enter their **Name** and **Email** to comment.

![Blog Post](https://docs.frappe.io/files/blog-post-comment-closed.png)  
![Blog Post](https://docs.frappe.io/files/blog-post-comment-open.png)
...
![Blog Post](https://docs.frappe.io/files/v-14-blog-post-disable-comments.png)

![Blog Post](https://docs.frappe.io/files/blog-post-no-comments.png)  
_Adding Comments Disabled_

Readers can give likes on their favorite blog posts.  
![Blog Post](https://docs.frappe.io/files/blog-post-like-default.png)  
![Blog Post](https://docs.frappe.io/files/blog-post-liked.png)  
_Like_

Check the **Disable Likes** option if you'd like to disable the ability for readers to give like to the current blog post.  
![Blog Post](https://docs.frappe.io/files/v-14-blog-post-disable-likes.png)  
![Blog Post](https://docs.frappe.io/files/blog-post-no-like.png)
...
![Blog Post](https://docs.frappe.io/files/v14-blog-post-enable-email-notification.png)
...
![Blogger](https://docs.frappe.io/files/v-14-blogger.png)  
_Blogger_

The preview will be shown at the end of the blog post.  
![Blogger Preview](https://docs.frappe.io/files/v-14-blogger-preview.png)  
_Blogger Preview_
...
![Blog Category](https://docs.frappe.io/files/blog-category.png)  
_Blog Category_

If you click on **See on Website** in the sidebar, you'll be redirected to a  
list of blogs under that category.

![Blog Category - General](https://docs.frappe.io/files/blog-category-web-view.png)  
_Blog Category - General_
...
![Google Search Preview](https://docs.frappe.io/files/v-14-blog-post-seo-meta.png)  
_Blog Post Google Search Preview_
...
![Facebook Sharing Debugger](https://docs.frappe.io/files/blog-post-facebook-debugger.png)  
_Using Facebook's Sharing Debugger Tool_
