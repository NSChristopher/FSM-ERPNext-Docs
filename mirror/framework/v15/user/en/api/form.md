---
title: "Form Scripts"
source_url: https://docs.frappe.io/framework/v15/user/en/api/form
...
![New Client Script](https://docs.frappe.io/files/client-script-form.png) _New Client Script for Form_
...
![Intro text example](https://docs.frappe.io/files/Screenshot%202022-04-23%20at%201.56.04%20AM.png) _Intro Text Example_

### frm.add\_custom\_button

Add a custom button in the inner toolbar of the page. Alias to [page.add\_inner\_button](https://docs.frappe.io/framework/v14/user/en/api/page#pageadd_inner_button).
