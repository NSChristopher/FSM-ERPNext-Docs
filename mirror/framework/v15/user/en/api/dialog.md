---
title: "Dialog API"
source_url: https://docs.frappe.io/framework/v15/user/en/api/dialog
...
Frappe provides a group of standard, interactive and flexible dialogs that are easy to configure and use. There's also an API for [Python](https://docs.frappe.io/framework/v14/user/en/api/py-dialog).
...
![Dialog](https://docs.frappe.io/files/dialog-api-custom-dialog.png)
...
![Msgprint](https://docs.frappe.io/files/dialog-api-msgprint.png)
...
![Msgprint with Primary Action](https://docs.frappe.io/files/dialog-api-msgprint-with-primary-action.png)
...
![Throw](https://docs.frappe.io/files/dialog-api-throw.png)
...
![Prompt](https://docs.frappe.io/files/dialog-api-prompt.png)
...
![Prompt](https://docs.frappe.io/files/dialog-api-confirm.png)
...
![Prompt](https://docs.frappe.io/files/dialog-api-warn.png)
...
![Show Alert](https://docs.frappe.io/files/dialog-api-show-alert.png)
...
![Show Progress](https://docs.frappe.io/files/dialog-api-progress.png)
...
-   `read_only_setters`: If you want to make setters (filters) read only so that users can't change the value of the filters then add those fields in the "read\_only\_setters".
...
![MultiSelectDialog](https://docs.frappe.io/files/dialog-api-multiselectdialog.png)
...
![MultiSelectDialog](https://docs.frappe.io/files/dialog-api-multiselectdialog-child-selection.png)
