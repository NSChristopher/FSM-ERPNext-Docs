---
title: "Dialog API"
source_url: https://docs.frappe.io/framework/v15/user/en/api/py-dialog
...
Frappe provides a group of standard, interactive and flexible dialogs that are easy to configure and use. There's also a more extensive API for [Javascript](https://docs.frappe.io/framework/v14/user/en/api/dialog).
...
![frappe.msgprint](https://docs.frappe.io/files/dialog-api-msgprint-py.png) _frappe.msgprint_
...
![frappe.msgprint with primary action](https://docs.frappe.io/files/dialog-api-msgprint-py-with-primary-action.png) _frappe.msgprint with primary action_
...
![Throw-py](https://docs.frappe.io/files/dialog-api-msgprint-py.png) _frappe.throw_
