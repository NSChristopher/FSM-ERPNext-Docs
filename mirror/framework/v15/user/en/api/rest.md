---
title: "REST API"
source_url: https://docs.frappe.io/framework/v15/user/en/api/rest
...
Refer documentation for [How to setup OAuth](https://docs.frappe.io/framework/v14/user/en/guides/integration/how_to_set_up_oauth).
