---
title: "List"
source_url: https://docs.frappe.io/framework/v15/user/en/api/list
...
![New Client Script](https://docs.frappe.io/files/client-script-list.png) _New Client Script for List_

The above customization will result in a list view that looks like this:

![List View Customized](https://docs.frappe.io/files/list-view-customized.png) _List View Customized_
