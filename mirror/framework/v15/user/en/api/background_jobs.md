...
source_url: https://docs.frappe.io/framework/v15/user/en/api/background_jobs
...
The `all` event is triggered every 4 minutes. This can be configured via the `scheduler_interval` key in [common\_site\_config.json](https://frappeframework.com/docs/v14/user/en/basics/sites#scheduler_tick_interval)
