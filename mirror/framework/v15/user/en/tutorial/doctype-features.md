...
source_url: https://docs.frappe.io/framework/v15/user/en/tutorial/doctype-features
...
> Learn more about various types of [DocType Naming](https://docs.frappe.io/framework/v14/user/en/basics/doctypes/naming).
...
Next: [Controller Methods](https://docs.frappe.io/framework/v14/user/en/tutorial/controller-methods)
