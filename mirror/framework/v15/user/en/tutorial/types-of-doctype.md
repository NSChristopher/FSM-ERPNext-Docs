...
source_url: https://docs.frappe.io/framework/v15/user/en/tutorial/types-of-doctype
...
![Library Membership DocType](https://docs.frappe.io/files/library-membership-doctype.gif)
...
![Library Membership Validation](https://docs.frappe.io/files/library-membership-validation.png)
...
![Library Transaction Doctype](https://docs.frappe.io/files/library-transaction-doctype.gif)
...
![Library Settings Doctype](https://docs.frappe.io/files/library-settings-doctype.gif)
...
Next: [Form Scripts](https://docs.frappe.io/framework/v14/user/en/tutorial/form-scripts)
