---
title: "Debugging"
source_url: https://docs.frappe.io/framework/v15/user/en/debugging
...
\> Learn more about Frappe Logs [here](https://docs.frappe.io/framework/v14/user/en/logging) and the Frappe Logging API from [here](https://docs.frappe.io/framework/v14/user/en/api/logging).
...
\> Learn more about the Client API [here](https://docs.frappe.io/framework/v14/user/en/api#javascript) </erpnext.projects.doctype.task.task.task>
...
_Caution: This modifies the behaviour of_ `bench start`
