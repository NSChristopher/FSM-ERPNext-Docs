---
title: "Bench"
source_url: https://docs.frappe.io/framework/v15/user/en/bench
...
To install the bench CLI and setup a Frappe environment, please follow the [installation instructions](https://docs.frappe.io/framework/v14/user/en/installation).
...
1.  [Bench Commands](https://docs.frappe.io/framework/v14/user/en/bench/bench-commands)
2.  [Frappe Commands](https://docs.frappe.io/framework/v14/user/en/bench/frappe-commands)
3.  [Command References](https://docs.frappe.io/framework/v14/user/en/bench/reference)
4.  [Extending the CLI](https://docs.frappe.io/framework/v14/user/en/bench/extending-the-cli)
