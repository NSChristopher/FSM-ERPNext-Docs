...
source_url: https://docs.frappe.io/framework/v15/user/en/bench/frappe-commands
...
> For references of any Bench commands, checkout [Bench Commands](https://docs.frappe.io/framework/v14/user/en/bench/bench-commands).
...
For more information and examples, see the [bench new-site](https://docs.frappe.io/framework/v14/user/en/bench/reference/new-site) reference.
...
For more information and examples, see the [bench backup](https://docs.frappe.io/framework/v14/user/en/bench/reference/backup) reference.
...
For more information and examples, see the [bench restore](https://docs.frappe.io/framework/v14/user/en/bench/reference/restore) reference.
...
For more information and examples, see the [bench partial-restore](https://docs.frappe.io/framework/v14/user/en/bench/reference/partial-restore) and [bench backup](https://docs.frappe.io/framework/v14/user/en/bench/reference/backup) reference.

#### Site App Management

You can install or uninstall Frappe Applications available on your Bench. To add Apps to your bench using `bench get-app` checkout [the docs](https://docs.frappe.io/framework/v14/user/en/bench/bench-commands#frequently-used).
...
For more information and examples, see the [bench uninstall-app](https://docs.frappe.io/framework/v14/user/en/bench/reference/uninstall-app) reference.

#### Site Migrations

Run patches, sync schema and rebuild files, translations and indexes on a particular site. Find out how site migrations work in [the docs](https://docs.frappe.io/framework/v14/user/en/database-migrations).

```
bench --site {site} migrate
```

For more information and examples, see the [bench migrate](https://docs.frappe.io/framework/v14/user/en/bench/reference/migrate) reference.
...
For more information and examples, see the [bench drop-site](https://docs.frappe.io/framework/v14/user/en/bench/reference/drop-site) reference.
...
For more information and examples, see the [bench reinstall](https://docs.frappe.io/framework/v14/user/en/bench/reference/reinstall) reference.
...
For more information and examples, see the [bench list-apps](https://docs.frappe.io/framework/v14/user/en/bench/reference/list-apps) reference.
...
```
$ bench --site site.local browse --user [email protected]
...
-   **build-search-index**: Builds search index for Websites. Refer to [Full Text Search API Docs](https://docs.frappe.io/framework/v14/user/en/api/full-text-search) for more information.
...
For more information and examples, see the [bench transform-database](https://docs.frappe.io/framework/v14/user/en/bench/reference/transform-database) reference.
...
For more information and examples, see the [bench trim-tables](https://docs.frappe.io/framework/v14/user/en/bench/reference/trim-tables) reference.
...
For more information and examples, see the [bench trim-database](https://docs.frappe.io/framework/v14/user/en/bench/reference/trim-database) reference.
...
The applied configuration for your sites gets applied as a combination of the bench directory's `common_site_config.json` and the site's own `site_config.json`. You can read more about this, [here](https://docs.frappe.io/framework/v14/user/en/basics/site_config). Bench provides an interface to view the applied `frappe.conf` values for your sites. You may choose to access this information in tabular or JSON formats.

```
bench --site {site} show-config
```

For more information and examples, see the [bench show-config](https://docs.frappe.io/framework/v14/user/en/bench/reference/show-config) reference.
...
For more information and examples, see the [bench set-config](https://docs.frappe.io/framework/v14/user/en/bench/reference/set-config) reference.
...
With version 13, the `-f` / `--format` option was introduced. This option allows you to display additional information about the branch and last commit. For more information and examples, see the [bench version](https://docs.frappe.io/framework/v14/user/en/bench/reference/bench-version) reference.
