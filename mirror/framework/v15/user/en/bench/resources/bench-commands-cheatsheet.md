...
source_url: https://docs.frappe.io/framework/v15/user/en/bench/resources/bench-commands-cheatsheet
...
-   `bench --site [sitename] export-fixtures [--app TEXT]` Export the [records defined in the app's hooks](https://docs.frappe.io/framework/v14/user/en/python-api/hooks#fixtures) as JSON files.
