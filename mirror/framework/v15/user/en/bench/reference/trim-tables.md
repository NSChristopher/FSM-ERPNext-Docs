...
source_url: https://docs.frappe.io/framework/v15/user/en/bench/reference/trim-tables
...
the [`restore`](https://docs.frappe.io/framework/v14/user/en/bench/reference/restore) command.
