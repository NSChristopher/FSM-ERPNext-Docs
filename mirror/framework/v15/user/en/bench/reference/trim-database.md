...
source_url: https://docs.frappe.io/framework/v15/user/en/bench/reference/trim-database
...
the [`partial-restore`](https://docs.frappe.io/framework/v14/user/en/bench/reference/partial-restore) command.
