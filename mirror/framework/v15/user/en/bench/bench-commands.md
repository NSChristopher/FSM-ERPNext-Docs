...
source_url: https://docs.frappe.io/framework/v15/user/en/bench/bench-commands
...
> Commands](https://docs.frappe.io/framework/v14/user/en/bench/frappe-commands).
...
checkout the [Site Config](https://docs.frappe.io/framework/v14/user/en/basics/sites#site-config) and [Bench Config docs](https://docs.frappe.io/framework/v14/user/en/bench/bench-commands#config-commands).
...
_bench-manager.local_'s `/desk` view.
