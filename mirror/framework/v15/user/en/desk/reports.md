---
title: "Introduction"
source_url: https://docs.frappe.io/framework/v15/user/en/desk/reports
...
The key difference in Frappe compared to other frameworks is that **meta-data** is also treated as data. This enables you to build front-ends very easily. We believe in a monolithic architecture, so Frappe comes with almost everything you need to build a modern web application. It has a full featured Admin UI called the Desk that handles forms, navigation, lists, menus, permissions, file attachment and much more out of the box. [Read more here](https://docs.frappe.io/framework/user/en/basics/why).
...
Before you can use Frappe, you need to install it. We have a complete [installation guide](https://docs.frappe.io/framework/user/en/installation) which covers all possibilities, this guide will also help you understand the backend stack.
