---
title: "Workspace"
source_url: https://docs.frappe.io/framework/v15/user/en/desk/workspace
...
[Learn More →](https://docs.frappe.io/framework/v14/user/en/desk/workspace/blocks)

![Workspace Blocks](https://docs.frappe.io/files/WorkspaceBlocks.gif)  
###Sidebar
...
[More →](https://docs.frappe.io/framework/v14/user/en/desk/workspace/customization#customizing-workspaces)
...
[Customizing Workspaces](https://docs.frappe.io/framework/v14/user/en/desk/workspace/customization#customizing-workspaces) and [Customizing Workspace Page](https://docs.frappe.io/framework/v14/user/en/desk/workspace/customization#customizing-workspace-page) are two different things.
