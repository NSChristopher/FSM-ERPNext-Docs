---
title: "Google Drive"
source_url: https://docs.frappe.io/framework/v15/user/en/integration/google_drive
...
2.  Check the _Enable_ checkbox.
3.  In the "Google Drive Picker" section, check the _Google Drive Picker Enabled_ checkbox.
4.  Enter your _App ID,_ _Client ID_ and _API Key_.
