...
source_url: https://docs.frappe.io/framework/v15/user/en/basics/directory-structure
...
Learn more about [apps](https://docs.frappe.io/framework/v14/user/en/basics/apps).
...
Learn more about [sites](https://docs.frappe.io/framework/v14/user/en/guides/basics/sites).
