---
title: "Controllers"
source_url: https://docs.frappe.io/framework/v15/user/en/basics/doctypes/controllers
...
| `on_change` | This is called when a document's values has been changed. This method is also called when db\_set is performed, so operation performed in this method should be idempotent. | X | X | X | X | X |
...
There are a lot of methods provided by default on the `doc` object. You can find the complete [list here](https://docs.frappe.io/framework/v14/user/en/api/document#document-methods).
...
-   VS Code users can install Python extension for better auto-complete - [https://code.visualstudio.com/docs/languages/python](https://code.visualstudio.com/docs/languages/python)
