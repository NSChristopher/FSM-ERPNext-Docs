---
title: "Apps"
source_url: https://docs.frappe.io/framework/v15/user/en/basics/apps
...
Learn more about [hooks](https://docs.frappe.io/framework/v14/user/en/python-api/hooks).
...
Learn more about [modules](https://docs.frappe.io/framework/v14/user/en/basics/doctypes/modules).
...
Learn more about [portal pages](https://docs.frappe.io/framework/v14/user/en/portal-pages).
