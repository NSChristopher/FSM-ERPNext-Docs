...
source_url: https://docs.frappe.io/framework/v15/user/en/basics/users-and-permissions
...
![User Roles](https://docs.frappe.io/files/user-roles.png) _User Roles_
...
![Role Blogger](https://docs.frappe.io/files/role-blogger.png) _Role Blogger_
...
![DocType Permissions](https://docs.frappe.io/files/doctype-permissions.png) _DocType Permissions_

If you expand the row, you will see many more options that can be configured. ![DocType Permissions Row](https://docs.frappe.io/files/doctype-permissions-detail.png) _DocType Permissions_
...
![Permission Level](https://docs.frappe.io/files/permission-level.png) _Permission Level_
...
![User Permissions Example](https://docs.frappe.io/files/user-permissions-example-1.png) _User Permission Record_
...
![Restricted Blog Post List](https://docs.frappe.io/files/user-permissions-example-2.png) _Restricted Blog Post List_
...
To hide a doctype from a User, remove the read permission from a Role using the [Role Permissions Manager](#role-permissions-manager).
...
![Password Policy](https://docs.frappe.io/files/password-policy.png) _Password Policy_
...
Frappe supports third party login providers. To setup a login provider you need to setup a **Social Login Key**. Learn more about it [here](https://docs.frappe.io/framework/v14/user/en/guides/integration/social_login_key).
