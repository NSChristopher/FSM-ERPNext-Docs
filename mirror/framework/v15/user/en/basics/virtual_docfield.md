...
source_url: https://docs.frappe.io/framework/v15/user/en/basics/virtual_docfield
...
![Person Record](https://docs.frappe.io/files/Screenshot%202022-02-14%20at%201.55.38%20PM.png)  
_Person Form_
...
![Person DocType](https://docs.frappe.io/files/Screenshot%202022-02-14%20at%201.55.08%20PM.png)  
_Person DocType_
...
![Full Name - Virtual DocField](https://docs.frappe.io/files/Screenshot%202022-02-14%20at%2012.18.20%20PM.png)  
_Person DocType - DocField_
...
This is a bit more restrictive given it allows you to write code directly from Desk. [Utils allowed in Server Scripts](https://docs.frappe.io/framework/v14/user/en/desk/scripting/script-api) and Document attributes can be accessed through this. Equivalent of the above property maybe as follows:
