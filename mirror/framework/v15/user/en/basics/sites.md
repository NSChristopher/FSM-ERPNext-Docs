---
title: "Sites"
source_url: https://docs.frappe.io/framework/v15/user/en/basics/sites
...
Configuration common to all sites can be put in this file. Learn more about [site configuration](https://docs.frappe.io/framework/v14/user/en/basics/site_config).
...
This directory is used by the scheduler to synchronize various jobs using the [file locking concept](https://en.wikipedia.org/wiki/File_locking).
...
To learn more about managing Site or Bench level configurations, checkout [this comprehensive document](https://docs.frappe.io/framework/v14/user/en/basics/site_config).
