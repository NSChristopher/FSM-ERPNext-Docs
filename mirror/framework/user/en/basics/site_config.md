...
| `mail_login` | is used as the second preference and "[\[email protected\]](https://docs.frappe.io/cdn-cgi/l/email-protection#8ae4e5fee3ece3e9ebfee3e5e4f9caeff2ebe7fae6efa4e9e5e7)" is used as fallback. |
