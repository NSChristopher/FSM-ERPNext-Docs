---
title: "Customization"
source_url: https://docs.frappe.io/framework/user/en/desk/workspace/customization
...
![Edit Workspace Details](https://docs.frappe.io/files/EditWorkspaceDetails.gif)  
###Create Duplicate  
You can create a duplicate of an existing workspace and can add or remove some blocks from it as per your need.  
![Duplicate Workspace](https://docs.frappe.io/files/DuplicateWorkspace.gif)  
###Delete Workspace  
Delete an existing workspace.  
![Delete Workspace](https://docs.frappe.io/files/DeleteWorkspace.gif)  
###Hide Workspace  
Hide your private workspaces.  
![Hide Workspace As User](https://docs.frappe.io/files/HideWorkspaceAsUser.gif)

Only `Workspace Manager` can hide public workspaces.  
![Hide Workspace As Workspace Manager](https://docs.frappe.io/files/HideWorkspaceAsWorkspaceManager.gif)

###Rearrange Position:  
You can drag & drop the workspace from the sidebar to change its position or make it a child/parent workspace.  
![Rearrage Workspace](https://docs.frappe.io/files/RearrangeWorkspace.gif)
...
###Add a new block  
![Add Block](https://docs.frappe.io/files/AddBlock.gif)  
###Edit an existing block  
![Edit Block](https://docs.frappe.io/files/EditBlock.gif)  
###Remove or delete an existing block  
![Delete Block](https://docs.frappe.io/files/DeleteBlock.gif)  
###Resize the width of a block  
![Resize Block](https://docs.frappe.io/files/ResizeBlock.gif)  
###Rearrange the position of a block  
![Rearrange Block](https://docs.frappe.io/files/RearrangeBlock.gif)
