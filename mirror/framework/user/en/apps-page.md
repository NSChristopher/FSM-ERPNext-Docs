---
title: "Apps Page"
source_url: https://docs.frappe.io/framework/user/en/apps-page
...
1.  User Level: Allows individual users to set their preferred default app.  
    ![](https://docs.frappe.io/files/SetAsDefault.png)  
    ![](https://docs.frappe.io/files/UserLevel.jpeg)
2.  System Level: Sets a global default app for all users.  
    ![](https://docs.frappe.io/files/SystemLevel.png)
