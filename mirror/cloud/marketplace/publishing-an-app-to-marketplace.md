...
source_url: https://docs.frappe.io/cloud/marketplace/publishing-an-app-to-marketplace
...
![Become Publisher Button location](https://docs.frappe.io/files/become-publisher.png)
...
![Marketplace Tab](https://docs.frappe.io/files/marketplace_tab_no_apps.png)
...
![Add App Dialog](https://docs.frappe.io/files/add_app_dialog.png)
...
![Add to Marketplace from GitHub](https://docs.frappe.io/files/add_from_github.png)

A marketplace app will be created with the selected app and a new page will open where you will be able to manage your  
marketplace app:

![Manage Marketplace App](https://docs.frappe.io/files/marketplace_app.png)
...
![List of Marketplace Apps](https://docs.frappe.io/files/marketplace_tab_with_app.png)
...
![Edit Description](https://docs.frappe.io/files/darkify_md.gif)

### Details Required for Publishing

Before our team publishes your app on marketplace, the details mentioned on [this](https://docs.frappe.io/docs/marketplace/marketpace-guidelines) page must be filled via your app overview page.

## Next Steps

After you have added the marketplace app along with the required details, you need to publish a particular release of your app, which is discussed in detail [here](https://docs.frappe.io/docs/marketplace/manage-marketplace-app).

We will approve the release (and the app, if its the first release) and your marketplace app will be live!

> SLA: Apps will be reviewed or published in 10 days time. If your app is still in Draft state after 10 days of adding it to marketplace. Please raise a ticket on [Support Portal](https://support.frappe.io/)
