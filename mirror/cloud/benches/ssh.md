---
title: "SSH Access"
source_url: https://docs.frappe.io/cloud/benches/ssh
upstream_updated: "11-05-2026 11:55:20"
...
> Manually selecting from text editor and copying can lead to invalid keys. If you _have_ to select the key, please **cat** the file and copy the output.
> 
> ```
> cat ~/.ssh/id_rsa.pub
> ```
...
![](https://docs.frappe.io/files/NfpXryi.png)

  

Clicking on the button will open up a dialog:

![SSH Access Cert Generation Dialog](https://docs.frappe.io/files/ssh_access_dialog_cert.png)
...
![SSH Access Certificate](https://docs.frappe.io/files/ssh_access_dialog.png)
...
![SSH Terminal](https://docs.frappe.io/files/ssh_terminal.png)
...
The ssh works by generating a certificate using the public key you provide. The certificate can **only** be used on a system containing the private key corresponding to the public key given and hence secure.
...
![fingerprint dashboard](https://docs.frappe.io/files/fingerprint-dashboard.png)
...
Windows users using Powershell (or Windows Terminal) need to execute the following command _**before**_ pasting the certificate:
...
![](https://docs.frappe.io/files/LVRChP9.png)
...
The recommended method is to push updates to your custom app on GitHub and then [update your benches](https://docs.frappe.io/cloud/benches/updating_a_bench) and sites.
...
In the rare instance that your bench has been deployed for a duration longer than a year and not updated since, attempting to SSH will lead to an error like so:
...
In such cases, please update your bench so that new bench version gets deployed onto which you shall be able to ssh
