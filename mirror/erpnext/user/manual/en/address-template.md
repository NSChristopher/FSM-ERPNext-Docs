...
source_url: https://docs.frappe.io/erpnext/user/manual/en/address-template
upstream_updated: "23-07-2026 17:22:13"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Address Template | ERPNext Documentation

An **Address Template** controls how ERPNext formats an [Address](https://docs.frappe.io/erpnext/address) when it appears on transactions, print formats, previews, and communications. Country-specific templates let each region use the expected order, labels, and optional fields.
...
![United States Address Template editor with Jinja fields and default status.](https://novacompanies.m.frappe.cloud/files/address-template-editor.png)
...
6.  Test at least one [Quotation](https://docs.frappe.io/erpnext/quotation), [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice), or relevant print preview.

![Formatted billing and shipping Addresses shown on a Customer.](https://novacompanies.m.frappe.cloud/files/customer-addresses-and-contacts.png)
...
The template engine exposes standard and Custom Fields from Address. See [Customize Form](https://docs.frappe.io/framework/customize-a-doctype) before referencing a custom field.
...
Address Templates affect [Customers](https://docs.frappe.io/erpnext/customer), [Suppliers](https://docs.frappe.io/erpnext/supplier), [Companies](https://docs.frappe.io/erpnext/company), Warehouses, Contacts, and transactions such as [Delivery Notes](https://docs.frappe.io/erpnext/delivery-note) wherever formatted Addresses are rendered.
...
-   preview a [Sales Order](https://docs.frappe.io/erpnext/sales-order) and a [Purchase Invoice](https://docs.frappe.io/erpnext/purchase-invoice);
...
-   [Print Formats](https://docs.frappe.io/framework/print-format)
