---
title: "Item Price"
source_url: https://docs.frappe.io/erpnext/user/manual/en/item-price
...
![](https://docs.frappe.io/files/item-price.png)
...
Visit the [Price Lists](https://docs.frappe.io/erpnext/price-lists) page to know more.
