...
source_url: https://docs.frappe.io/erpnext/user/manual/en/user-permission-based-on-hierarchy
...
![](https://docs.frappe.io/files/14Khhti.png)
...
![](https://docs.frappe.io/files/wRl6sKW.png)
...
![](https://docs.frappe.io/files/4L4Co0O.png)
