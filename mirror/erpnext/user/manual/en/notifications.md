---
title: "Notification"
source_url: https://docs.frappe.io/erpnext/user/manual/en/notifications
upstream_updated: "02-03-2026 23:35:34"
...
1.  Define what events you want to watch under Send Alert On. Events are:
    ...
    6.  Custom: Send a notification to an [Email Account](https://docs.frappe.io/erpnext/email-account) selected.
2.  Select the Document Type you want to watch changes on. From Version 16, You can also select child Document Types if Send Alert On is set to _Days Before_or _Days After_.
...
![Setting Subject](https://docs.frappe.io/files/email-alert-subject.png)
...
![Setting Condition](https://docs.frappe.io/files/notification%20screenshotb9a4a2.jpg)
...
![Setting Property in Notification](https://docs.frappe.io/files/email-alert-subject.png)

### 1.5 Example

1.  Defining the Criteria ![Defining Criteria](https://docs.frappe.io/files/email-alert-1.png)
2.  Setting the Recipients and Message ![Set Message](https://docs.frappe.io/files/email-alert-2.png)
...
2.  Click on "Create a Slack App". ![Set Message](https://docs.frappe.io/files/slack_notification_1.png)
3.  Give your App a name and choose the right workspace. Once your app is created, go to the "Incoming Webhooks" section and add a new Webhook to Workspace. ![Set Message](https://docs.frappe.io/files/slack_notification_2.png)
4.  Copy the created link, go back to ERPNext and use it to create a new Slack Webhook URL in Integrations > Slack Webhook URL. ![Set Message](https://docs.frappe.io/files/slack_notification_3.png)
...
![Set Message](https://docs.frappe.io/files/slack_notification_4.png)
...
![Notifications Dropdown](https://docs.frappe.io/files/system-notifications-channel.png)
...
![Notifications Dropdown](https://docs.frappe.io/files/system-notification.png)
...
![Notifications Dropdown](https://docs.frappe.io/files/notification-log.png)
...
![Notifications Dropdown](https://docs.frappe.io/files/send-system-notification.png)

4.  WhatsApp

* * *

In **Version 13** we have introduced an additional channel to send alerts - **WhatsApp**: ![Notifications WhatsApp Channel](https://docs.frappe.io/files/twilio-channel.png)
...
![Twilio Settings](https://docs.frappe.io/files/twilio-settings.png)

### 4.1 Twilio Settings

In order to configure Twilio settings, you need to first obtain Twilio credentials from your Twilio Account's account settings. You can only add those phone numbers that have been activated in your Twilio Account with WhatsApp access. ![Twilio Credentials](https://docs.frappe.io/files/twilio-credentials.png)

### 4.2 Message Format

WhatsApp allows their users to only send those message templates that are pre-approved by them to your customers. Failure to do so might result in restrictions on you Twilio account. ![Pre Approved Message Template](https://docs.frappe.io/files/twilio-pre-approved-message.png)

5.  SMS

* * *

In **Version 13** we have introduced an additional channel to send alerts - **SMS**: ![SMS Channel](https://docs.frappe.io/files/sms-notification-channel.png)
...
2.  [Document Follow](https://docs.frappe.io/erpnext/document-follow)
