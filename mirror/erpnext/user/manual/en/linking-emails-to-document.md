...
source_url: https://docs.frappe.io/erpnext/user/manual/en/linking-emails-to-document
...
![Add Customer/Supplier in Contact](https://docs.frappe.io/files/contact-link.png)  
...
![With Filters](https://docs.frappe.io/files/email_aggregation.gif)
...
![Add Customer/Supplier in Contact](https://docs.frappe.io/files/enable_email_link.png)  
...
![Add Customer/Supplier in Contact](https://docs.frappe.io/files/email_link.gif)

> Note: Email linking with BCC is not supported. You have to add unique email as receipient in TO or CC.

### 3\. Related Topics

1.  [Auto Email Reports](https://docs.frappe.io/erpnext/auto-email-reports)
2.  [Sending Email from any Document](https://docs.frappe.io/erpnext/sending-email)
