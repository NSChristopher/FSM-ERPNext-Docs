...
source_url: https://docs.frappe.io/erpnext/user/manual/en/closing-stock-balance
upstream_updated: "02-03-2026 15:21:13"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Closing Stock Balance

Note: In v16 the closing stock balance has renamed as [Stock Closing Entry](https://docs.frappe.io/erpnext/stock-closing-entry)
...
![](https://docs.frappe.io/files/QqWv6uJ.png)
