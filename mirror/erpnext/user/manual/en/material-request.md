...
source_url: https://docs.frappe.io/erpnext/user/manual/en/material-request
upstream_updated: "27-02-2026 17:52:13"
...
-   **Customer Provided**: If the material being requested is to be provided by Customer. To know more about this, visit the [Customer Provided Item](https://docs.frappe.io/erpnext/customer-provided-items) page.

![Material Request](https://docs.frappe.io/files/material-request-flowchart.png)
...
![Screenshot 2024-07-09 at 2.36.44 PM](https://docs.frappe.io/files/Screenshot%202024-07-09%20at%202.36.44%20PM.png)  
...
![Screenshot 2024-07-09 at 2.40.52 PM](https://docs.frappe.io/files/Screenshot%202024-07-09%20at%202.40.52%20PM.png)

### 1.1 Alternate ways of creating a Material Request

A Material Request can be generated automatically:

-   From a [Sales Order](https://docs.frappe.io/erpnext/sales-order). While creating MR, user can choose to ignore or include Projected Quantity. Accordingly, Sales Order Items are fetched to MR.
-   When the Projected Quantity of an Item in Stores (Warehouses) reaches a particular level.
-   From your a [Production Plan](https://docs.frappe.io/erpnext/production-plan) to plan your manufacturing activities.

If your Items are inventory items, you must also mention the Warehouse where you expect these Items to be delivered. This helps to keep track of the [Projected Quantity](https://docs.frappe.io/erpnext/projected-quantity) for this Item.
...
-   **Barcode**: You can track Items using [barcodes](https://docs.frappe.io/erpnext/track-items-using-barcode).
...
You can print your Material Request on your company's letterhead. Read [Letter head documentation](https://docs.frappe.io/erpnext/letter-head) to learn more.

#### Print Headings

Material Request headings can also be changed when printing the document. You can do this by selecting a **Print Heading**. To create new Print Headings go to: Home > Settings > Printing > Print Heading. Know more [here](https://docs.frappe.io/erpnext/print-headings).
...
-   [Request For Quotation](https://docs.frappe.io/erpnext/request-for-quotation)
...
![Screenshot 2024-07-09 at 2.38.58 PM](https://docs.frappe.io/files/Screenshot%202024-07-09%20at%202.38.58%20PM.png)

### 2.7 Automatically generate Material Requests

Material Requests can be generated automatically by enabling the setting in [Stock Settings](https://docs.frappe.io/erpnext/stock-settings#9-automatic-material-request) and setting the level in the [Item form](https://docs.frappe.io/erpnext/item#34-automatic-reordering). When the stock level dips below a certain quantity, setting a reorder will automatically create material requests for the Item.
