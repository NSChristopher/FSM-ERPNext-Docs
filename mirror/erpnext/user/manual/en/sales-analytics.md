---
title: "Sales Reports and Analytics | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/sales-analytics
upstream_updated: "25-07-2026 09:07:53"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Sales Reports and Analytics | ERPNext Documentation
...
-   Use consistent [Customers](https://docs.frappe.io/erpnext/customer), Territories, Sales Persons, Item Groups, and Warehouses.
...
![The fully loaded Selling dashboard with sales-order trends, summary cards, and report links.](https://novacompanies.m.frappe.cloud/files/sales-reports-workspace-v2.png)

![Sales Analytics for Nova Electronics Trading with Sales Order values for Northstar Retail.](https://novacompanies.m.frappe.cloud/files/sales-report-filters-v2.png)
...
| Which invoices remain unpaid? | [Accounts Receivable](https://docs.frappe.io/erpnext/accounts-receivable) |
| Which sales are profitable? | Gross Profit |
| What is the CRM pipeline? | [Sales Pipeline](https://docs.frappe.io/erpnext/sales-pipeline) or CRM Analytics |
...
[Sales Orders](https://docs.frappe.io/erpnext/sales-order) track confirmed demand, delivery progress, and billing progress. Review statuses and percentage fields to separate:
...
Salesperson reports depend on the Sales Team table. Confirm each transaction contains the correct [Sales Person contribution](https://docs.frappe.io/erpnext/sales-persons-in-the-sales-transactions).

Target variance also depends on [Sales Person Target Allocation](https://docs.frappe.io/erpnext/sales-person-target-allocation), Fiscal Year, Item Group, and Monthly Distribution.
...
Use the [General Ledger](https://docs.frappe.io/erpnext/general-ledger) and stock reports when accounting or inventory values need reconciliation.
...
-   [Sales Pipeline](https://docs.frappe.io/erpnext/sales-pipeline)
