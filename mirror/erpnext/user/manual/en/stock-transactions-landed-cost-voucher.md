...
source_url: https://docs.frappe.io/erpnext/user/manual/en/stock-transactions-landed-cost-voucher
upstream_updated: "04-07-2026 11:55:34"
...
![Landed Cost Voucher](https://docs.frappe.io/files/landed-cost-voucher.png)
...
![Landed Cost Voucher](https://docs.frappe.io/files/landed-cost-distribution.png)
...
From version 16 of ERPNext, users can create a Landed Cost Voucher against a Stock Entry with the purpose set to 'Manufacture'.  
This feature allows users to include additional costs—such as electricity charges or rent—into the final valuation rate of the manufactured product.
...
![](https://docs.frappe.io/files/Screenshot%202025-06-16%20at%208.07.42%20PM.png)
...
![](https://docs.frappe.io/files/Screenshot%202025-07-30%20at%2011.19.43%20PM.png)

### 4\. Related Topics

1.  [Delivery Trip](https://docs.frappe.io/erpnext/delivery-trip)
