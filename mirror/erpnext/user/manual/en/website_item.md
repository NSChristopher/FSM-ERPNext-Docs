---
title: "Website Item"
source_url: https://docs.frappe.io/erpnext/user/manual/en/website_item
upstream_updated: "02-03-2026 12:09:36"
...
The Prerequisites here are [Items](https://docs.frappe.io/erpnext/item).
...
![Publish Item](https://docs.frappe.io/files/publish-item.gif)
...
![Website Item Page](https://docs.frappe.io/files/web-item-page-overview.png) _Website Item Page_
...
![Website Item Product Details](https://docs.frappe.io/files/web-item-product-details.png)
...
![Recommended Items](https://docs.frappe.io/files/recommended-items.png)
...
![Website Item Offers](https://docs.frappe.io/files/web-item-offers.png)
...
2.  **Set Meta Tags**: Meta tags help with SEO. See [Web Page](https://docs.frappe.io/erpnext/web-page) to know how to add them.
3.  **Website Item Groups**: In this table you can select existing or create new [Item Groups](https://docs.frappe.io/erpnext/item-group) to classify items on your website. The Website Item will be visible under Item Group Pages of the Item Groups mentioned in this table.

#### Advanced Display Content

You can add an additional styled section using Bootstrap 4 markup for the Website Item page. ![Website Item Advacned Display](https://docs.frappe.io/files/web-item-advanced-display.png)
...
You can also add a **Pricing Rule** with a **Discount Percentage** or **Discount Amount** on the existing item price, to show **striked prices**. ![Website Item Page Striked Price](https://docs.frappe.io/files/web-item-striked-price.png)
