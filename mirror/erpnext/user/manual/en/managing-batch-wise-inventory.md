...
source_url: https://docs.frappe.io/erpnext/user/manual/en/managing-batch-wise-inventory
...
![Batch Item](https://docs.frappe.io/files/batchwise-stock-1.png)

You can create a new Batch from:

`Stock > Documents > Batch > New`

Read [Stock batch](https://docs.frappe.io/erpnext/batch.html) to learn more.
...
![Batch in Purchase Receipt](https://docs.frappe.io/files/batchwise-stock-2.png)
...
![Batch in Delivery Note](https://docs.frappe.io/files/batchwise-stock-3.png)
...
![Batchwise Stock Balance](https://docs.frappe.io/files/batchwise-stock-4.png)
