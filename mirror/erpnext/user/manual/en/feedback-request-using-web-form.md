...
source_url: https://docs.frappe.io/erpnext/user/manual/en/feedback-request-using-web-form
...
![](https://docs.frappe.io/files/oUDbd8e.png)
...
![](https://docs.frappe.io/files/eWKqJ50.png)  
**Create a Notification**

A Notification should be created to send a link to a user following which they will submit a rating. You can define the conditions for triggering an email based on standard features of [Notification](https://docs.frappe.io/erpnext/notifications). Following is the help on how to define a message and link which would take user to a Web Form and allow submitting a rating.
