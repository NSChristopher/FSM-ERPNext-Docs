...
source_url: https://docs.frappe.io/erpnext/user/manual/en/email-template
upstream_updated: "02-03-2026 23:35:31"
...
![Email Template](https://docs.frappe.io/files/email-template-example.png)
...
You can set a Default Email Template for each document type via [Customize Form](https://docs.frappe.io/erpnext/customize-form).

### 1.2 How to get fieldnames

The fieldnames you can use in your email template are the fields in the document from which you are sending the email. You can find out the fields of any documents via [Customize Form](https://docs.frappe.io/erpnext/customize-form) and selecting the document type (e.g. Sales Order)
