---
title: "Record Incoterms and Named Places | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/incoterm-and-named-place
upstream_updated: "25-07-2026 09:07:53"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Record Incoterms and Named Places | ERPNext Documentation
...
The fields are available on supported documents such as a [Quotation](https://docs.frappe.io/erpnext/quotation), [Sales Order](https://docs.frappe.io/erpnext/sales-order), [Delivery Note](https://docs.frappe.io/erpnext/delivery-note), [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice), [Purchase Order](https://docs.frappe.io/erpnext/purchase-order), and [Purchase Invoice](https://docs.frappe.io/erpnext/purchase-invoice).
...
For stock purchases, [Landed Cost Voucher](https://docs.frappe.io/erpnext/landed-cost-voucher) may be relevant when additional costs need to be included in inventory valuation.

## Terms and printed documents

Use [Terms and Conditions](https://docs.frappe.io/erpnext/terms-and-conditions) to state the complete commercial wording, Incoterm edition, responsibilities, exclusions, and documentary requirements.
...
-   [Shipping Rule](https://docs.frappe.io/erpnext/shipping-rule)
