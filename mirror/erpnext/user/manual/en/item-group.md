---
title: "Item Group"
source_url: https://docs.frappe.io/erpnext/user/manual/en/item-group
...
![](https://docs.frappe.io/files/item_groups.png)
...
![](https://docs.frappe.io/files/item-group-new2af55d.gif)
...
A default item tax template will be applied to all items belonging to this group. Similarly a Tax Category can also be selected, visit [Quotation](https://docs.frappe.io/erpnext/quotation) to know more about Tax Categories.
...
-   **Slideshow**: A slideshow for the Item Group, just like in an Item. Visit the [Homepage](https://docs.frappe.io/erpnext/homepage) page in Website module to know more.
