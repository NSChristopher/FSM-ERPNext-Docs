...
source_url: https://docs.frappe.io/erpnext/user/manual/en/paytm-integration
...
![Razorpay Settings](https://docs.frappe.io/files/paytm_credentials.png)
...
![Razorpay Settings](https://docs.frappe.io/files/paytm_settings.png)
...
![Stripe COA](https://docs.frappe.io/files/paytm_coa.png)
...
![Payment Gateway Account](https://docs.frappe.io/files/payment_gateway_account_paytm.png)
