...
source_url: https://docs.frappe.io/erpnext/user/manual/en/human-resource-setup
...
Check [Setup](https://frappehr.com/docs/v14/user/manual/en/setting-up) for more details on each of masters, global _HR Settings_ and other configurations.
