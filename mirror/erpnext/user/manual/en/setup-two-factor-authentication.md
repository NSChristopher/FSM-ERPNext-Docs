...
source_url: https://docs.frappe.io/erpnext/user/manual/en/setup-two-factor-authentication
...
![Enable Two Factor Auth](https://docs.frappe.io/files/twofactor-1.png)
...
![Role Enable Two Factor Auth](https://docs.frappe.io/files/twofactor-2.png)

If using SMS authentication, please make sure that your SMS settings are updated

![SMS Settings](https://docs.frappe.io/files/twofactor-3.png)

If using Email, make sure that your outgoing Email account settings are updated

![Email Settings](https://docs.frappe.io/files/twofactor-4.png)
...
![Email Notify Two Factor](https://docs.frappe.io/files/twofactor-5.png)  
![QR Code Page](https://docs.frappe.io/files/twofactor-6.png)
...
![Two Factor Scan App](https://docs.frappe.io/files/twofactor_app.jpeg)

If either of Email/SMS is used as the authentication method, you get notifications also

![Email and SMS](https://docs.frappe.io/files/twofactor-8.png)
