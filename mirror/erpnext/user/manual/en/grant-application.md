...
source_url: https://docs.frappe.io/erpnext/user/manual/en/grant-application
...
![Online Grant Application row](https://docs.frappe.io/files/grant_application_row.png)  
![Online Grant Application](https://docs.frappe.io/files/online_grant_application_1.png)  
![Online Grant Application](https://docs.frappe.io/files/grant_portal.png)

To Generate Grant Application go to:

> Non Profit > Grant Application > New.

![Grant Application](https://docs.frappe.io/files/grant_application.png)
