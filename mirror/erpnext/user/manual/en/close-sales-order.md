---
title: "Close Sales Order | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/close-sales-order
upstream_updated: "24-07-2026 09:24:31"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Close Sales Order | ERPNext Documentation

A submitted [Sales Order](https://docs.frappe.io/erpnext/sales-order) can be closed when the customer no longer wants the remaining quantity delivered or billed. Closing preserves the order and its completed transactions while removing the outstanding balance from active fulfilment.
...
-   Any accepted quantity has already been delivered through a [Delivery Note](https://docs.frappe.io/erpnext/delivery-note) or billed through a [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice).
-   The customer has agreed that the remaining quantity will not be fulfilled.
-   You do not need to correct the original order. Use [Cancel and Amend](https://docs.frappe.io/erpnext/amending-sales-order-after-submit) when the submitted details themselves are wrong.
...
-   Completed [Delivery Notes](https://docs.frappe.io/erpnext/delivery-note), [Sales Invoices](https://docs.frappe.io/erpnext/sales-invoice), and [Payment Entries](https://docs.frappe.io/erpnext/payment-entry) remain linked to the order.
...
The available action can depend on your permissions and the current document state. Ask an administrator to check [Role-Based Permissions](https://docs.frappe.io/erpnext/role-based-permissions) if you cannot see it.
...
| The submitted order contains an incorrect customer, item, quantity, rate, or date | [Cancel and Amend](https://docs.frappe.io/erpnext/amending-sales-order-after-submit) |
| Several open orders need to be closed together | [Short Close Multiple Orders](https://docs.frappe.io/erpnext/short-close-multiple-orders) |
| You need to deliver or invoice only part of the order now | Use [Partial Fulfilment](https://docs.frappe.io/erpnext/partial-fulfilment-of-sales-order) and leave the order open |
| Goods already delivered are being returned | Create a [Sales Return](https://docs.frappe.io/erpnext/sales-return) |
...
-   [Partial Fulfilment of Sales Order](https://docs.frappe.io/erpnext/partial-fulfilment-of-sales-order)
