...
source_url: https://docs.frappe.io/erpnext/user/manual/en/service-level-agreement
upstream_updated: "28-02-2026 12:43:45"
...
![Service Level Agreement](https://docs.frappe.io/files/sla-setting.png)
...
![Service Level](https://docs.frappe.io/files/priorities.png)
...
![SLA Support Hours](https://docs.frappe.io/files/sla-support-hours.png)

1.  Save.

![SLA](https://docs.frappe.io/files/sla.png)
...
![SLA in Issue](https://docs.frappe.io/files/sla-entity-type.png)
...
![SLA Issue](https://docs.frappe.io/files/reset-sla.gif)

### 3.3 Time respond / resolve in Issues

The time to respond to an Issue and the time to resolve will be shown:  
![SLA in Issue](https://docs.frappe.io/files/sla-in-issue.png)
...
-   Set the statuses on which you want to pause SLA in the SLA document. You can also add custom statuses here.  
    ![Service Level](https://docs.frappe.io/files/pause-sla.png)
-   When the status is changed to any of the above, resolution and response fields are unset and the dashboard indicators change to:  
    ![Service Level](https://docs.frappe.io/files/hold-indicator.png)
-   When the status of the issue changes back to a non-hold status (which is not configured in the "Pause SLA On" table), the **Total Hold time** field will be set in your Issue document.  
    ![Service Level](https://docs.frappe.io/files/total-hold-time.png)  
