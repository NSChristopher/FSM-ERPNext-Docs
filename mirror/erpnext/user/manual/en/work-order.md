---
title: "Work Order"
source_url: https://docs.frappe.io/erpnext/user/manual/en/work-order
upstream_updated: "27-02-2026 17:56:31"
...
![Work Order](https://docs.frappe.io/files/manufacturing-flow-wo.png)
...
The **Work Order** can be generated from the [Production Plan](https://docs.frappe.io/erpnext/production-plan) based on Sales Orders.
...
5.  If the selected BOM has Operations mentioned in it, the system will fetch all Operations from BOM, these values can be changed. Refer [section 3.2](https://docs.frappe.io/erpnext/work-order#32-operations-table) to know more.
    
6.  Set the Planned Start Date (an Estimated Date at which you want the Production to begin). ![Work Order](https://docs.frappe.io/files/work-order.png)
    
7.  **Use Multi-Level BOM**: This is enabled by default. If you want to plan materials for sub-assemblies of the Item you're manufacturing leave this enabled. If you plan and manufacture the sub-assemblies separately, you can disable this checkbox. To know more, visit [this page](https://docs.frappe.io/erpnext/managing-multi-level-bom).
...
A Work Order can also be directly created from a [Sales Order](https://docs.frappe.io/erpnext/sales-order#214-after-submitting).
...
The Source Warehouse can be changed for the raw material items used here. The default Warehouse can be set at the Item level in the [Item](https://docs.frappe.io/erpnext/item#28-item-defaults) master or globally in [Stock Settings](https://docs.frappe.io/erpnext/stock-settings#23-default-warehouse).

-   **Required Quantity**: This will be calculated automatically based on the [Bill Of Materials](https://docs.frappe.io/erpnext/bill-of-materials).
...
![WO material Qty](https://docs.frappe.io/files/work-order-material-qty.png)

### 3.2 Operations table

Materials can be transferred against a Work Order or a Job Card. This is usually fetched from the [Bill Of Materials](https://docs.frappe.io/erpnext/bill-of-materials), but you can change it in the Work Order also.

The following will be fetched from the BOM:

-   In the Operations table: The Workstations where the Operations will be performed ![PO Opeartions](https://docs.frappe.io/files/PO-operations.png)
-   In the Items table: The Operations which will be performed on the Items ![PO reassigning Operations](https://docs.frappe.io/files/PO-reassigning-operations.png)
...
![Work Order Operation Costs](https://docs.frappe.io/files/wo-operation-cost.png)

### 3.4 More Information

Here the Item Description and Stock UOM is shown for the Item being manufactured.

When a Work Order is created from a [Material Request](https://docs.frappe.io/erpnext/material-request), it'll be shown here.
...
-   Click on 'Start'. Once you click on Start, Job Cards will be created for the [Operations](https://docs.frappe.io/erpnext/job-card) involved.

![Transfer Materials](https://docs.frappe.io/files/PO-material-transfer.png)

-   Mention the quantity of materials to be transferred in this run.

![Material Transfer Qty](https://docs.frappe.io/files/PO-material-transfer-qty.png)
...
![Stock Entry for PO](https://docs.frappe.io/files/PO-material-transfer-updated.png)
...
To know more about Job Cards, visit [this page](https://docs.frappe.io/erpnext/job-card).
...
![Update Finished Goods](https://docs.frappe.io/files/PO-FG-update.png)
...
![PO - stop](https://docs.frappe.io/files/PO-stop.png)

You can also re-open the stopped Work Order.

![Reopen Work Order](https://docs.frappe.io/files/reopen-work-order.png)
...
![Return Components](https://docs.frappe.io/files/return-components.png)

You can also checks the returned components against the work order using Work Order Consumed Materials report

![Return Components Qty](https://docs.frappe.io/files/work-order-consumed-materials-returned-qty.png)
...
![](https://docs.frappe.io/files/additional-transfer-option-in-wo.png)
...
1.  [Job Card](https://docs.frappe.io/erpnext/job-card)
2.  [Pick List](https://docs.frappe.io/erpnext/pick-list#22-create-pick-list-from-work-order)
