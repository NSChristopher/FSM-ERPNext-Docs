...
source_url: https://docs.frappe.io/erpnext/user/manual/en/managing-fractions-in-uom
...
![UoM Must be Whole No](https://docs.frappe.io/files/uom-fraction-1.png)
...
![UoM Validation Message](https://docs.frappe.io/files/uom-fraction-2.png)
