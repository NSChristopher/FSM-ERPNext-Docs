---
title: "Membership"
source_url: https://docs.frappe.io/erpnext/user/manual/en/membership
...
![Membership](https://docs.frappe.io/files/membership.png)
...
For recurring membership payments you can setup razorpay subscription for members. You can find instructions on setting up razorpay [here](https://docs.frappe.io/docs/v13/user/manual/en/erpnext_integration/razorpay-integration)
...
You can find instructions on setting up razorpay [here](https://docs.frappe.io/docs/v13/user/manual/en/erpnext_integration/razorpay-integration). You can setup billing in Membership Settings in the Non Profit module.

![Membership](https://docs.frappe.io/files/razorpay-enabled.png)
...
![Membership](https://docs.frappe.io/files/membership-settings.png)
...
Membership Type corresponds to your RazorPay plan. You can read more about Membership Plan [here](https://docs.frappe.io/docs/v13/user/manual/en/non_profit/membership_type)

![Membership](https://docs.frappe.io/files/plan.png)
...
If you already have members you can import them using the [Data Import Tool](https://docs.frappe.io/docs/v13/user/manual/en/setting-up/data/data-import). Here's a [video tutorial](https://www.youtube.com/watch?v=WlGD35DM5LI) of the same.
...
![Membership](https://docs.frappe.io/files/member.png)
...
![Membership](https://docs.frappe.io/files/razorpay-webhook.png)
