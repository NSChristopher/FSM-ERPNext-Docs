...
source_url: https://docs.frappe.io/erpnext/user/manual/en/order-entry
...
![Order Entry](https://docs.frappe.io/files/order-entry.png)
...
![Order Entry](https://docs.frappe.io/files/order-entry-bill.png)

### Sales Invoice

To print the invoice, you can click on the Invoice Link and print the invoice

![Sales Invoice](https://docs.frappe.io/files/restaurant-invoice.png)
