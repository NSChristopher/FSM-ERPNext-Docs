...
source_url: https://docs.frappe.io/erpnext/user/manual/en/quality-inspection
upstream_updated: "27-02-2026 17:50:44"
...
-   **Create an** [**Item**](https://docs.frappe.io/erpnext/item).
-   **Enable Quality Inspection Criteria in the Item master**. On enabling either checkboxes, **submission** of a stock delivery/receipt document will be allowed only after a Quality Inspection is done against it: ![Enable Quality Inspection](https://docs.frappe.io/files/quality-inspection-pre-requisite.png)
-   (Optional) **Create a Quality Inspection Template**. You can add inspection parameters and acceptance criteria in the template, which can be easily fetched into any Quality Inspection. After saving the template, you can set this template in the Item Master (as shown above). ![Quality Inspection Template](https://docs.frappe.io/files/quality-inspection-template.png)
...
![Quality Inspection](https://docs.frappe.io/files/quality-inspection-1.png)
...
![Numeric Quality Check](https://docs.frappe.io/files/quality-inspection-numeric-reading.png)
...
![Non-numeric Quality Check](https://docs.frappe.io/files/quality-inspection-non-numeric-reading.png)
...
![Acceptance Criteria Formula](https://docs.frappe.io/files/acceptance-criteria-formula.png)
...
![Manual Inspection](https://docs.frappe.io/files/quality-inspection-manual-reading.png)
...
1.  [Purchase Receipt](https://docs.frappe.io/erpnext/purchase-receipt)
2.  [Delivery Note](https://docs.frappe.io/erpnext/delivery-note)
3.  [Stock Entry](https://docs.frappe.io/erpnext/stock-entry)
4.  [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice)
5.  [Purchase Invoice](https://docs.frappe.io/erpnext/purchase-invoice)
6.  [Job Card](https://docs.frappe.io/erpnext/job-card)
