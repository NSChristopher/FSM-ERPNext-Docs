...
source_url: https://docs.frappe.io/erpnext/user/manual/en/authorization-rule
...
![Authorization Rule](https://docs.frappe.io/files/authorization-rule.png)
...
![Authorization Rule](https://docs.frappe.io/files/new-authorization-rule.png)

If the Sales User tries submitting the Sales Order of value higher than 10,000, then he will get an error message.

![Authorization Rule Validation Message](https://docs.frappe.io/files/authorization-rule-validation-message.png)

> If you wish to restrict Sales User from submitting Sales Orders, then instead of creating Authorization Rule, you should remove submit privilege for Sales User from [Role Permission Manager](https://docs.frappe.io/erpnext/role-based-permissions).
