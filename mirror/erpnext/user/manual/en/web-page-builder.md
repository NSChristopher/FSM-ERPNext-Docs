...
source_url: https://docs.frappe.io/erpnext/user/manual/en/web-page-builder
...
1.  Follow the steps to [create a Web Page](https://docs.frappe.io/erpnext/web-page).
...
![New Web Page with Page Builder](https://docs.frappe.io/files/new-web-page-with-page-builder.png)  
_New Web Page with Page Builder_

![Page Builder Edit Values Dialog](https://docs.frappe.io/files/page-builder-edit-values-dialog.png)  
_Page Builder Edit Values Dialog_

View your Web Page by clicking on **See on Website** in the sidebar.

![Web Page](https://docs.frappe.io/files/web-page-with-page-builder-preview.png)  
...
![More Sections](https://docs.frappe.io/files/web-page-with-more-sections.png)  
_Web Page with another section_

![More Sections - Preview](https://docs.frappe.io/files/web-page-with-more-sections-preview.png)  
...
![Section Options](https://docs.frappe.io/files/page-builder-section-options.png)  
_Section Options_
