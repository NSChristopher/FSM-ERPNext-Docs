---
title: "Pick List"
source_url: https://docs.frappe.io/erpnext/user/manual/en/pick-list
upstream_updated: "02-03-2026 16:18:39"
...
-   [Stock Item](https://docs.frappe.io/erpnext/item)
...
1.  Go to the Pick List list, click on New. ![Unsaved Pick List](https://docs.frappe.io/files/pick-list-unsaved-doc.png)
...
7.  **Item Locations:** This will have the information of the item location (Warehouse), Serial Number for serialized items and batch no for batched items. ![Item Locations](https://docs.frappe.io/files/pick-list-item-locations.png)
    

If Serial Numbers are involved, the Item row will look like this: ![Item Location Detail](https://docs.frappe.io/files/pick-list-item-location-detail.png)  
8\. Save and Submit. ![Submitted Pick List](https://docs.frappe.io/files/pick-list-submitted-doc.png)

### 2.1 Create Pick List from a Sales Order

1.  Go to a [Sales Order](https://docs.frappe.io/erpnext/sales-order).
...
![](https://docs.frappe.io/files/PL-GetItems.png)
...
1.  Go to a [Work Order](https://docs.frappe.io/erpnext/work-order).
2.  Click **Create Pick List** button.
3.  You'll see the dialog box asking for the quantity of Finished Goods Item. This is required to calculate the number of raw material items required to manufacture the entered quantity of Finished Goods Item. ![Dialog For qty](https://docs.frappe.io/files/pick-list-dialog-for-qty.png)
...
1.  Go to a [Material Request](https://docs.frappe.io/erpnext/material-request).
...
![pick_manual](https://docs.frappe.io/files/pick_manual.gif)
...
2.  [Work Order](https://docs.frappe.io/erpnext/work-order)
3.  [Material Request](https://docs.frappe.io/erpnext/material-request)
