...
source_url: https://docs.frappe.io/erpnext/user/manual/en/print-settings
...
![Print Settings](https://docs.frappe.io/files/print-settings.png)
...
![Incompact Print Format Settings](https://docs.frappe.io/files/incompact-print.png)

This is what the Compact Print Format looks like:  
![Compact Print Format Settings](https://docs.frappe.io/files/compact-print.png)
...
You can enable raw printing and print to many supported thermal printers. Read [Raw Printing](https://docs.frappe.io/erpnext/raw-printing) to know more.

### 5\. Related Topics

1.  [Print Format](https://docs.frappe.io/erpnext/print-format)
2.  [Print Style](https://docs.frappe.io/erpnext/print-style)
3.  [Print Headings](https://docs.frappe.io/erpnext/print-headings)
4.  [Custom Translations](https://docs.frappe.io/erpnext/custom-translations)
