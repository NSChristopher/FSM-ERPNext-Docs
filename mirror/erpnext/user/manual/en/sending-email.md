...
source_url: https://docs.frappe.io/erpnext/user/manual/en/sending-email
upstream_updated: "02-03-2026 23:35:33"
...
![Send Email](https://docs.frappe.io/files/send-email.gif)

**Note:** You must have outgoing [Email Accounts](https://docs.frappe.io/erpnext/email-account) set up for this.
...
![Email Queue](https://docs.frappe.io/files/email-queue.png)
...
![Email Print Options](https://docs.frappe.io/files/email-print-options.png)

-   **Select Print Format**: The print format of the document. Know more about Print Format [here](https://docs.frappe.io/erpnext/print-format).
...
2.  [Email Account](https://docs.frappe.io/erpnext/email-account)
3.  [Email Inbox](https://docs.frappe.io/erpnext/email-inbox)
