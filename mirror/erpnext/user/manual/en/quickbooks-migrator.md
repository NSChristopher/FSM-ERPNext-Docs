---
title: "QuickBooks Migrator (Deprecated) | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/quickbooks-migrator
upstream_updated: "31-07-2026 13:15:28"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# QuickBooks Migrator (Deprecated) | ERPNext Documentation

> **Deprecated**
> 
> The built-in ERPNext QuickBooks Migrator is no longer available in current ERPNext releases. It was removed from the ERPNext develop branch on January 17, 2025 in [PR #45240](https://github.com/frappe/erpnext/pull/45240). The instructions below apply only to older ERPNext versions that still contain the QuickBooks Migrator and should not be used for a current migration.
> 
> For a current QuickBooks migration, export the required data from QuickBooks, clean and map it, then use [Data Import](https://docs.frappe.io/erpnext/data-import) for masters, the [Chart of Accounts Importer](https://docs.frappe.io/erpnext/chart-of-accounts-importer), the [Opening Invoice Creation Tool](https://docs.frappe.io/erpnext/opening-invoice-creation-tool), [Stock Reconciliation](https://docs.frappe.io/erpnext/stock-reconciliation), and opening Journal Entries. Follow the [Accounting Migration Overview](https://docs.frappe.io/erpnext/accounting-migration-overview) to plan and validate the migration.

## Legacy instructions for older ERPNext versions
