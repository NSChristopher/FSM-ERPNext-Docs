...
source_url: https://docs.frappe.io/erpnext/user/manual/en/include-document-link-in-notification-email
upstream_updated: "04-03-2026 16:28:43"
...
2.  Create a new Notification for any DocType. In this case, we have taken an example of sending an Email Notification on creation of every new Material Request as shown below.  
    ![](https://docs.frappe.io/files/6WPgqY6.png)
