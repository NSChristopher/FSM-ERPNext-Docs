---
title: "Item Variants"
source_url: https://docs.frappe.io/erpnext/user/manual/en/item-variants
...
3.  Only the Variants of the Item (blue t-shirt in size small) can be practically used. Therefore it would be ideal to decide whether an item 'Has Variants' or not directly when creating it.  
    [Has Variants](https://docs.frappe.io/files/item-has-variants.png)
4.  On selecting 'Has Variants' a table will appear. Specify the variant attributes for the Item in the table. In case the attribute has Numeric Values, you can specify the range and create intervals based on the increment values.  
    [Valid Attributes](https://docs.frappe.io/files/item-attributes.png)
...
![](https://docs.frappe.io/files/item-variants.png)

To learn more about setting attributes, check out [Item Attributes](https://docs.frappe.io/erpnext/item-attribute)
...
![](https://docs.frappe.io/files/variant-manufacturer.png)
...
1.  [Item Attribute](https://docs.frappe.io/erpnext/item-attribute)
