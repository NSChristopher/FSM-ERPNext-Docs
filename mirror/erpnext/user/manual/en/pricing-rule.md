...
source_url: https://docs.frappe.io/erpnext/user/manual/en/pricing-rule
...
Use Pricing Rules for repeatable exceptions. For a one-time adjustment, enter a discount directly on the transaction. For tiered campaigns with several slabs, consider a [Promotional Scheme](https://docs.frappe.io/erpnext/promotional-scheme).

## Before you begin

-   Create the relevant [Items](https://docs.frappe.io/erpnext/item), Item Groups, Brands, Customers, Suppliers, and [Price Lists](https://docs.frappe.io/erpnext/price-lists).
...
| Coupon Code Based | Requires a matching [Coupon Code](https://docs.frappe.io/erpnext/coupon-code) before the rule is applied. |
...
-   **Margin:** adds a percentage or amount over the fetched rate. See [Adding Margin](https://docs.frappe.io/erpnext/adding-margin).
...
For a focused example, see [Setting up a Buy 1 Get 1 Free Pricing Rule](https://docs.frappe.io/erpnext/setting-up-buy-1-get-1-free-pricing-rule).

## Apply and verify the Pricing Rule

1.  Create or open a supported sales or purchase transaction, such as a [Quotation](https://docs.frappe.io/erpnext/quotation), [Sales Order](https://docs.frappe.io/erpnext/sales-order), Purchase Order, or [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice).
...
-   [Loyalty Program](https://docs.frappe.io/erpnext/loyalty-program)
