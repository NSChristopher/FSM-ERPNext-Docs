---
title: "Warehouse"
source_url: https://docs.frappe.io/erpnext/user/manual/en/warehouse
upstream_updated: "27-04-2026 10:47:36"
...
![Warehouse](https://docs.frappe.io/files/warehouse.png)
...
![Warehouse](https://docs.frappe.io/files/warehouse-tree.png)

### 2.2 Warehouse Account

In ERPNext, if you enable [Perpetual Inventory](https://docs.frappe.io/erpnext/v13/user/manual/en/stock/perpetual-inventory), every Warehouse must belong to a specific company to maintain  
...
1.  [Stock Entry Purpose](https://docs.frappe.io/erpnext/v13/user/manual/en/stock/articles/stock-entry-purpose)
2.  [Stock Level Report](https://docs.frappe.io/erpnext/v13/user/manual/en/stock/stock-level-report)
