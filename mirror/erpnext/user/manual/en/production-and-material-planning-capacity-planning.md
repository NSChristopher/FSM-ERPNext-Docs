...
source_url: https://docs.frappe.io/erpnext/user/manual/en/production-and-material-planning-capacity-planning
...
![Work Order](https://docs.frappe.io/files/capacity_planning_settings.png)
...
![Work Order](https://docs.frappe.io/files/work_order_with_operations.png)
...
![Work Order](https://docs.frappe.io/files/work_station_capacity.png)
...
![Work Order](https://docs.frappe.io/files/job_card_timing.png)
...
![Work Order](https://docs.frappe.io/files/work_order_calendar.png)
...
![Work Order](https://docs.frappe.io/files/capacity_planning_error.png)
