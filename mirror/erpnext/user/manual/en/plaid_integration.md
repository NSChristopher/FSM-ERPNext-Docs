...
source_url: https://docs.frappe.io/erpnext/user/manual/en/plaid_integration
...
![Enable Plaid](https://docs.frappe.io/files/plaid_enable.gif)
...
![Link your bank account](https://docs.frappe.io/files/new_account_creation.gif)
...
![Synchronize your bank account](https://docs.frappe.io/files/plaid_synchronization.gif)
