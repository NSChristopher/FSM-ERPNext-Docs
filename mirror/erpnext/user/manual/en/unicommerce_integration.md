...
source_url: https://docs.frappe.io/erpnext/user/manual/en/unicommerce_integration
...
![unicommerce auth setup](https://docs.frappe.io/files/unicommerce-auth-setup.png)
...
![Unicommerce product category](https://docs.frappe.io/files/unicommerce-product-category.png)  
![ERPNext item group](https://docs.frappe.io/files/erpnext-item-group.png)
...
![Unicommerce workflow](https://docs.frappe.io/files/unicommerce_workflow.png)
...
![default sales order sync](https://docs.frappe.io/files/sales-order-sync.png)
...
![channel specific sales order sync](https://docs.frappe.io/files/unicommerce-channel-setup.png)
...
![generate invoice button](https://docs.frappe.io/files/generate-invoice.png)
...
![Unicommerce shipment manifest](https://docs.frappe.io/files/shipment-manifest.png)
...
![Unicommerce details section](https://docs.frappe.io/files/unicommerce-details-section.png)
...
![Unicommerce return warehouse](https://docs.frappe.io/files/return-warehouse-map.png)
