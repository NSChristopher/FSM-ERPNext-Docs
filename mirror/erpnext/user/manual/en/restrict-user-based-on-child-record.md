...
source_url: https://docs.frappe.io/erpnext/user/manual/en/restrict-user-based-on-child-record
upstream_updated: "27-02-2026 17:56:02"
...
![Creating a new user permission](https://docs.frappe.io/files/new-user-permission.png)
...
![Applicable For](https://docs.frappe.io/files/advanced-control.png)
...
![Hide Descendant Permissions](https://docs.frappe.io/files/hide-descendant-permissions.png)
...
![Ignore User Permissions on specific properties](https://docs.frappe.io/files/ignore-user-permissions.png)
...
To know more, go to the [System Settings page](https://docs.frappe.io/erpnext/system-settings#14-permissions).
...
![Permitted Documents for User report](https://docs.frappe.io/files/permitted-documents.png)

Note: If you cannot access Sales Order or any other document type in this list, make sure you've set the [roles](https://docs.frappe.io/erpnext/role-based-permissions) correctly.

For example, the user, Bruce is restricted to Company 'Unico Plastics Inc.' ![User restricted to Company](https://docs.frappe.io/files/user-restricted-to-company.png)

### 3\. Related Topics

1.  [Adding Users](https://docs.frappe.io/erpnext/adding-users)
2.  [Role and Role Profile](https://docs.frappe.io/erpnext/role-and-role-profile)
3.  [Role Based Permissions](https://docs.frappe.io/erpnext/role-based-permissions)
