---
title: "Customer Group | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/customer-group
upstream_updated: "23-07-2026 17:22:13"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Customer Group | ERPNext Documentation

A **Customer Group** classifies similar [Customers](https://docs.frappe.io/erpnext/customer) in a hierarchy. Groups make sales analysis easier and can supply common price, payment, credit, and accounting defaults to Customers and transactions.
...
-   Confirm the required [Price List](https://docs.frappe.io/erpnext/price-lists), [Payment Terms](https://docs.frappe.io/erpnext/payment-terms), receivable account, and credit policy.
...
-   Use [Data Import](https://docs.frappe.io/erpnext/data-import) for a reviewed hierarchy with many groups.
...
Defaults cascade only when a more specific value is not set. Verify the resulting values on a new [Quotation](https://docs.frappe.io/erpnext/quotation), [Sales Order](https://docs.frappe.io/erpnext/sales-order), or [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice) before relying on a new group configuration.
...
-   Add company-specific accounts only when the group must post differently from the company's default Debtors account in the [Chart of Accounts](https://docs.frappe.io/erpnext/chart-of-accounts).
-   Add a credit-limit row for each company that needs a group-level limit.

Use [Credit Limit](https://docs.frappe.io/erpnext/credit-limit) guidance to define which transactions should be blocked. A payment schedule controls when amounts are due; it does not increase available credit.
...
-   review [Sales Analytics](https://docs.frappe.io/erpnext/sales-reports) by Customer Group; and
