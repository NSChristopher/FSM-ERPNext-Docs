...
source_url: https://docs.frappe.io/erpnext/user/manual/en/tracking-progress
...
If 'Allow Self Enroll' is enabled for a particular program, an entry is created automatically on behalf of the student. Each student will have only one program enrollment for each program. You can learn more about program enrollment \[here\]({{ docs\_base\_url }}/user/manual/en/education/program-enrollment)  
![Program Enrollment](https://docs.frappe.io/files/desk-program-enrollment.png)
...
![Course Enrollment List](https://docs.frappe.io/files/desk-course-enrollment-list.png)
...
![Course Activity List](https://docs.frappe.io/files/desk-course-activity-list.png)  
![Course Activity](https://docs.frappe.io/files/desk-course-activity.png)
