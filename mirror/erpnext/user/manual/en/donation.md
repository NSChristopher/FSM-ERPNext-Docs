---
title: "Donation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/donation
...
Before creating a Donation, you need to create a [Donor](https://docs.frappe.io/docs/v13/user/manual/en/non_profit/donor) first.
...
![Donation](https://docs.frappe.io/files/donation.png)
...
You can set up RazorPay for capturing donations. You can find instructions on setting up razorpay [here](https://docs.frappe.io/docs/v13/user/manual/en/erpnext_integration/razorpay-integration).
...
You can find instructions on setting up razorpay [here](https://docs.frappe.io/docs/v13/user/manual/en/erpnext_integration/razorpay-integration).
...
![Donation Settings](https://docs.frappe.io/files/donation-settings.png)
...
![Donation Webhook](https://docs.frappe.io/files/donation-webhook.png)
