---
title: "Selling Settings | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/selling-settings
upstream_updated: "02-08-2026 17:28:42"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Selling Settings | ERPNext Documentation
...
-   Create the required [Customer Groups](https://docs.frappe.io/erpnext/customer-group), [Territories](https://docs.frappe.io/erpnext/territory), and [Price Lists](https://docs.frappe.io/erpnext/price-list) first.
...
Customer defaults reduce data entry when creating a [Customer](https://docs.frappe.io/erpnext/customer) or converting a Lead or Quotation into a Customer.

  

![Customer Defaults tab in ERPNext Selling Settings](https://novacompanies.m.frappe.cloud/files/customer-defaults-1440.png)
...
![Pricing tab in ERPNext Selling Settings](https://novacompanies.m.frappe.cloud/files/pricing-1440.png)

| Field | What it means |
| --- | --- |
| Default Price List | Provides the default selling Price List for a [Quotation](https://docs.frappe.io/erpnext/quotation), [Sales Order](https://docs.frappe.io/erpnext/sales-order), Delivery Note, and Sales Invoice. |
...
| Allow editing Price List rate in transactions | Makes Price List Rate editable in sales item tables. Keep it disabled when rates must always come from [Item Price](https://docs.frappe.io/erpnext/item-price) records. |
...
| Calculate Product Bundle price based on child Item rates | Makes packed-item rates editable and calculates the [Product Bundle](https://docs.frappe.io/erpnext/product-bundle) price from its child items. A manually changed bundle rate is recalculated when the document is saved. |
...
![Transaction tab in ERPNext Selling Settings](https://novacompanies.m.frappe.cloud/files/transaction-1440.png)

| Field | What it means |
| --- | --- |
| Is Sales Order required to create Sales Invoice or Delivery Note? | Set to Yes to require a Sales Order before a [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice) or [Delivery Note](https://docs.frappe.io/erpnext/delivery-note). A Customer can allow Sales Invoice creation without a Sales Order as an exception. |
...
| Blanket Order Allowance (%) | Controls how much a Sales Order may exceed the quantity agreed in a [Blanket Order](https://docs.frappe.io/erpnext/blanket-order). |
...
![Advanced Features tab in ERPNext Selling Settings](https://novacompanies.m.frappe.cloud/files/advanced-features-1440.png)
...
![Subcontracting Inward tab in ERPNext Selling Settings](https://novacompanies.m.frappe.cloud/files/subcontracting-inward-1440.png)
...
![Document Naming tab in ERPNext Selling Settings](https://novacompanies.m.frappe.cloud/files/document-naming-1440.png)
