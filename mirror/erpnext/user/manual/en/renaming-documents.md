...
source_url: https://docs.frappe.io/erpnext/user/manual/en/renaming-documents
...
Check [List of Renamable Documents](https://docs.frappe.io/erpnext/renaming-documents#list-of-renamable-documents) for the list of all the documents that can be renamed in the system.
...
![Document Renaming](https://docs.frappe.io/files/using-rename-documents-1.gif)
...
![Document Renaming](https://docs.frappe.io/files/using-rename-documents-2.gif)
