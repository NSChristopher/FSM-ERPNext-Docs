---
title: "Data Import"
source_url: https://docs.frappe.io/erpnext/user/manual/en/data-import
upstream_updated: "27-04-2026 14:37:18"
...
![](https://docs.frappe.io/files/image79c0b4.png)  
_Download Template Dialog box_
...
4.  _After you choose the export type, every field appears in the list. **Mandatory** fields show a red \* next to the name. **Conditional** fields (for example **Depends On** or autoname-related) show a small **info** icon—point at it to read the note._
5.  _Fields that are ticked but not mandatory are ones with **Include in Import Template** on—set on the **DocType** or in **Customize Form**—so they show in the list by default without being required._
...
1.  After updating your template file, go back to the Data Import form and attach the file by clicking on the **Attach** button.  
    ![](https://docs.frappe.io/files/imagef9ce89.png)  
    _Attaching file for import_
...
3.  Once the Sheet is uploaded, the system validates the sheet and gives the result on screen before importing the data  
    ![](https://docs.frappe.io/files/image799c07.png)
...
![](https://docs.frappe.io/files/imagebff69b.png)  
_Duplicate Name Error_
...
![](https://docs.frappe.io/files/imagedf8b35.png)  
_Child records importing_
...
3.  When we try to download the template, we can apply filters, something like this  
    ![](https://docs.frappe.io/files/image0baff8.png)
4.  We click on **Export.**
5.  Now, based on the template, the existing records look like this:

![](https://docs.frappe.io/files/image7a4518.png)
...
![](https://docs.frappe.io/files/imageebf859.png)
...
![](https://docs.frappe.io/files/imaged49cb3.png)  
_Google sheet Data File_
...
![](https://docs.frappe.io/files/imagebbb644.png)  
_Post Import using google sheets_
...
-   Import Using Google Sheets  
    ![](https://docs.frappe.io/files/imageb8e55f.png)

2.  After clicking **Attach**, you will see multiple upload options:  
    ![](https://docs.frappe.io/files/imageb4e113.png)
