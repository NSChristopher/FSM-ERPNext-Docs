---
title: "Sell Items in Different Units of Measure | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/Selling-in-different-UOM
upstream_updated: "25-07-2026 09:07:53"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Sell Items in Different Units of Measure | ERPNext Documentation
...
-   The required [Units of Measure](https://docs.frappe.io/erpnext/unit-of-measure-uom).
-   The Item's Stock UOM.
-   Accurate conversion factors.
-   UOM-specific [Item Prices](https://docs.frappe.io/erpnext/item-price) or a conversion-based pricing policy.
...
1.  Open the [Item](https://docs.frappe.io/erpnext/item).
...
Alternatively, enable **Price Not UOM Dependent** on the [Price List](https://docs.frappe.io/erpnext/price-lists) when ERPNext should derive the alternate-UOM price using the conversion factor.
...
-   [Unit of Measure](https://docs.frappe.io/erpnext/unit-of-measure-uom)
