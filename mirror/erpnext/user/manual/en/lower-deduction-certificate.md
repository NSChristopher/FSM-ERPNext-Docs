...
source_url: https://docs.frappe.io/erpnext/user/manual/en/lower-deduction-certificate
upstream_updated: "27-02-2026 17:56:00"
...
2.  [Tax Withholding Category](https://docs.frappe.io/erpnext/tax-withholding-category)
...
4.  Enter the [Fiscal Year](https://docs.frappe.io/erpnext/fiscal-year).
...
![Lower Deduction Certificate](https://docs.frappe.io/files/lower-deduction-certificate.png)
...
![Tax Withholding Category](https://docs.frappe.io/files/tax-withholding-category.png)
...
![Supplier With Tax Withholding Category](https://docs.frappe.io/files/supplier-with-tax-withholding-category.png)
...
![Lower TDS in Purchase Invoice](https://docs.frappe.io/files/lower-tax-withholding-in-purchase-invoice.png)

### 4\. Related Topics

1.  [Tax Withholding Category](https://docs.frappe.io/erpnext/tax-withholding-category)
