...
source_url: https://docs.frappe.io/erpnext/user/manual/en/document-naming-settings
...
2.  Edit the series as required with unique prefixes for each series.  
    he first prefix will be the default prefix. Each new prefix Naming Series must be added on a new line. The newly added naming series will be available in the document.

![document naming settings](https://docs.frappe.io/files/document_naming_settings.gif)
...
3.  If you want the user to explicitly select a series instead of the default one, check the “User must always select” checkbox.  
    here will be no default naming series if this is ticked.
...
![Fiscal year in Naming Series](https://docs.frappe.io/files/year-naming-series.png)
...
To know more about this, [visit this article](https://docs.frappe.io/erpnext/naming-series-current-value).
...
![Amended Naming Series](https://docs.frappe.io/files/Screenshot%202024-11-21%20at%2012.17.06%E2%80%AFPM.png)
...
1.  [Bulk Rename](https://docs.frappe.io/erpnext/bulk-rename)
