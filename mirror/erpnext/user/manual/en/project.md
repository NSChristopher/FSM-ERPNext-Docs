---
title: "Project"
source_url: https://docs.frappe.io/erpnext/user/manual/en/project
upstream_updated: "28-02-2026 11:25:02"
...
![](https://docs.frappe.io/files/imagec3fe96.png)
...
1.  **From Template**: If you have an existing [Project Template](https://docs.frappe.io/erpnext/project-template), you can choose to create your project using this template.
...
3.  **Project Type**: You can classify your projects into different [types](https://docs.frappe.io/erpnext/project-type), e.g., Internal or External.
...
![](https://docs.frappe.io/files/image2d8eef.png)
...
> Learn more about allowing users to view projects - click [here](https://docs.frappe.io/erpnext/project-customer-portal)

![](https://docs.frappe.io/files/imagebf5e91.png)
...
> To learn more about Timesheets, click [here](https://docs.frappe.io/erpnext/timesheets).

![](https://docs.frappe.io/files/image1e72e3.png)
...
![](https://docs.frappe.io/files/imagecf9da7.png)
...
![](https://docs.frappe.io/files/imagebeb9e1.png)

## Related Topics

1.  [Task](https://docs.frappe.io/erpnext/tasks)
2.  [Project Type](https://docs.frappe.io/erpnext/project-type)
3.  [Project Template](https://docs.frappe.io/erpnext/project-template)
