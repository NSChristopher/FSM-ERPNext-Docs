...
source_url: https://docs.frappe.io/erpnext/user/manual/en/exotel_integration
...
![Connect Applet](https://docs.frappe.io/files/connect_applet.png)  
![Call Popup Section](https://docs.frappe.io/files/create_popup_section.png)
...
![After Conversation Ends Section](https://docs.frappe.io/files/after_conversation_ends_section.png)

![After call ends section](https://docs.frappe.io/files/passthru_end_call.png)
...
![No Response Section](https://docs.frappe.io/files/no_response.png)

![After call ends section](https://docs.frappe.io/files/passthru_missed_call.png)
