...
source_url: https://docs.frappe.io/erpnext/user/manual/en/google_calendar
upstream_updated: "28-02-2026 12:38:02"
...
-   Creating an Event in ERPNext  
    ![](https://docs.frappe.io/files/erpnext-gc.gif)
-   Deleting an Event in ERPNext  
    ![](https://docs.frappe.io/files/gc-erpnext.gif)
...
-   Syncing Events from Google Calendar to ERPNext  
    ![](https://docs.frappe.io/files/gc-sync.gif)
