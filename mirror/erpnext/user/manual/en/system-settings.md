---
title: "System Settings | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/system-settings
upstream_updated: "15-08-2026 18:01:49"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# System Settings | ERPNext Documentation
...
-   [Global Defaults](https://docs.frappe.io/erpnext/global-defaults)
-   [Session Defaults](https://docs.frappe.io/erpnext/session-defaults)
-   [Set Language](https://docs.frappe.io/erpnext/set-language)
-   [Set Precision](https://docs.frappe.io/erpnext/set-precision)
-   [User Permissions](https://docs.frappe.io/erpnext/user-permissions)
-   [Two Factor Authentication](https://docs.frappe.io/erpnext/two-factor-authentication)
-   [File Manager](https://docs.frappe.io/erpnext/file-manager)
