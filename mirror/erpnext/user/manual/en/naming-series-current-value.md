...
source_url: https://docs.frappe.io/erpnext/user/manual/en/naming-series-current-value
...
![Update Series Section](https://docs.frappe.io/files/current-no-1.png)

#### Select Prefix

Considering our scenario, prefix for Sales Order will be "SO".

![Series Prefix](https://docs.frappe.io/files/current-no-2.png)
...
![Series Current Value](https://docs.frappe.io/files/current-no-3.png)
