---
title: "Stock Entry"
source_url: https://docs.frappe.io/erpnext/user/manual/en/restrict-purpose-of-stock-entry
upstream_updated: "03-04-2026 11:03:33"
...
-   **Material Transfer for Manufacturing**: If raw materials are being transferred for manufacturing. The transfer can happen against a [Work Order](https://docs.frappe.io/erpnext/work-order) or a [Job Card](https://docs.frappe.io/erpnext/job-card). To know more, visit the [Bill Of Materials](https://docs.frappe.io/erpnext/bill-of-materials) page.
-   **Material Consumption for Manufacture**: There can be multiple consumption stock entries against a manufacturing Work Order. [Refer this link for more details](https://docs.frappe.io/erpnext/material_consumption)
...
-   **Send to Subcontractor**: If the Material is being issued for a sub-contract activity. This entry is made from a Purchase Order. To know more, visit the [subcontracting](https://docs.frappe.io/erpnext/subcontracting) page.

To know more in detail about the stock entry purpose, [visit this page](https://docs.frappe.io/erpnext/user/manual/en/stock-entry-purpose).
...
Stock Entries for Manufacturing purposes are usually created from a [Work Order](https://docs.frappe.io/erpnext/work-order). To create a Stock Entry manually for other purposes, follow these steps:
...
![Stock Entry](https://docs.frappe.io/files/stock-entry.png)
...
-   **Inspection Required**: If a [Quality Inspection](https://docs.frappe.io/erpnext/quality-inspection) needs to be performed on the Items before submitting the Stock Entry.
...
![Stock Entry Type](https://docs.frappe.io/files/stock-entry-type.png)
...
![](https://docs.frappe.io/files/imaged7013f.png)
...
![](https://docs.frappe.io/files/CleanShot%202026-04-03%20at%2010.44.32@2x.png)
...
![Stock Entry Additional Costs](https://docs.frappe.io/files/additional-costs-table.png)
...
![Stock Entry Item Valuation Rate](https://docs.frappe.io/files/stock-entry-item-valuation-rate.png)

  

### 3.4 Accounting Dimensions

You can tag different transactions based on different dimensions. By default, [Projects](https://docs.frappe.io/erpnext/project) can be considered as a dimension as it is a common practice to track costs of different projects. To know more about Accounting Dimensions, [visit this page](https://docs.frappe.io/erpnext/accounting-dimensions).

### 3.5 Printing Settings

#### Letterhead

You can print your Purchase Receipt on your company's letterhead. Know more [here](https://docs.frappe.io/erpnext/letter-head).

#### Print Headings

Purchase Receipt headings can also be changed when printing the document. You can do this by selecting a **Print Heading**. To create new Print Headings go to: Home > Settings > Printing > Print Heading. Know more [here](https://docs.frappe.io/erpnext/print-headings).
...
![Additional Costs General Ledger](https://docs.frappe.io/files/stock-entry-additional-cost.png)

  

![Additional Costs General Ledger](https://docs.frappe.io/files/additional-costs-general-ledger.png)
...
![Additional Costs General Ledger](https://docs.frappe.io/files/stock-entry-submit.png)
...
![](https://docs.frappe.io/files/CleanShot%202026-04-03%20at%2011.01.51@2x.png)
...
![](https://docs.frappe.io/files/CleanShot%202026-04-03%20at%2011.02.51@2x.png)
...
1.  [Stock Entry Purpose](https://docs.frappe.io/erpnext/stock-entry-purpose)
2.  [Stock Reconciliation](https://docs.frappe.io/erpnext/stock-reconciliation)
3.  [Opening Stock Balance Entry For Serialized And Batch Item](https://docs.frappe.io/erpnext/opening-stock-balance-entry-for-serialized-and-batch-item)
4.  [Stock Reconciliation](https://docs.frappe.io/erpnext/stock-reconciliation)
5.  [Work Order](https://docs.frappe.io/erpnext/work-order)
6.  [Production Plan](https://docs.frappe.io/erpnext/production-plan)
7.  [Job Card](https://docs.frappe.io/erpnext/job-card)
