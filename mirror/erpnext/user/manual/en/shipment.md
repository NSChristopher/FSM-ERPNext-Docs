---
title: "Shipment"
source_url: https://docs.frappe.io/erpnext/user/manual/en/shipment
upstream_updated: "28-02-2026 15:49:32"
...
-   Company and Customer [Address](https://docs.frappe.io/erpnext/address) with Postal Code, Email Address and Phone Number set.
-   Customer [Contact](https://docs.frappe.io/erpnext/contact).
...
![Unsaved Shipment](https://docs.frappe.io/files/unsaved-shipment.png)
...
![Submitted Shipment](https://docs.frappe.io/files/shipment-submitted.png)
...
![Submitted Shipment](https://docs.frappe.io/files/shipment-from-delivery-note.png)
...
![Submitted Shipment](https://docs.frappe.io/files/shipment-parcel.png)
...
You can also automate rate comparison, label generation, tracking, etc. using our [Shipping Integration](https://docs.frappe.io/erpnext/erpnext_shipping).

### 4\. Related Topics

1.  [Delivery Note](https://docs.frappe.io/erpnext/delivery-note)
2.  [Packing Slip](https://docs.frappe.io/erpnext/packing-slip)
