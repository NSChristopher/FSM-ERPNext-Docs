...
source_url: https://docs.frappe.io/erpnext/user/manual/en/customer-provided-items
upstream_updated: "02-03-2026 17:16:50"
...
![Customer Provided Material Request](https://docs.frappe.io/files/material-request-customer-provided.png)

Here are the steps on how to setup a 'Customer Provided' item.

1.  Got to [Item Doctype](https://docs.frappe.io/erpnext/stock) and add a new 'Customer Provided' item.
...
![Item Purchase Details](https://docs.frappe.io/files/item-customer-provided.png)
...
![Material Request in Production Plan](https://docs.frappe.io/files/material-request-production-plan.png)
...
![Stock Entry from Material Request](https://docs.frappe.io/files/create-mr-from-production-plan.png)
