---
title: "Issue"
source_url: https://docs.frappe.io/erpnext/user/manual/en/issue
upstream_updated: "28-02-2026 14:14:20"
...
> [\[email protected\]](https://docs.frappe.io/cdn-cgi/l/email-protection) and it will automatically create an Issue in our system.

To access the Issue list, go to:

> Home > Support > Issues > Issue

![Issue](https://docs.frappe.io/files/issue.png)
...
Issues are automatically created if you use the **append to feature** in [Email Account](https://docs.frappe.io/erpnext/email-account#32-incoming-email-accounts).
...
-   **Customer**: If the email was sent from a [Customer](https://docs.frappe.io/erpnext/customer) stored in your ERPNext account, then a Customer link will appear in this field.
...
User can select the [Service Level Agreement](https://docs.frappe.io/erpnext/service-level-agreement) (SLA) from the list.
...
![SLA](https://docs.frappe.io/files/new-issue.gif)
...
![Response Details](https://docs.frappe.io/files/response.png)
...
![Resolution](https://docs.frappe.io/files/resolution.png)
...
> Issues can be assigned automatically among Users using [Assignment Rule](https://docs.frappe.io/erpnext/assignment-rule).
...
![Assign Issue](https://docs.frappe.io/files/issue-assign.png)
...
1.  [Issue Type and Priority](https://docs.frappe.io/erpnext/issue-type-and-priority)
