...
source_url: https://docs.frappe.io/erpnext/user/manual/en/check-link-between-documents
...
![Checking Document Links](https://docs.frappe.io/files/using-document-links-1.gif)
