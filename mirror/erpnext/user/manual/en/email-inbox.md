---
title: "Email Inbox"
source_url: https://docs.frappe.io/erpnext/user/manual/en/email-inbox
upstream_updated: "02-03-2026 23:35:32"
...
To know how to add a new User, go to the [User page](https://docs.frappe.io/erpnext/adding-users).

## 2\. Create an Email Domain

Email Domain for the following Services is available out-of-the-box and you can directly proceed to create an [Email Account](https://docs.frappe.io/erpnext/email-account). Know more about creating an Email Domain [here](https://docs.frappe.io/erpnext/email-domain).
...
![Email Service](https://docs.frappe.io/files/email-service.png)
...
![Email Domain](https://docs.frappe.io/files/email-domain.png)
...
![Email Password](https://docs.frappe.io/files/email-password.png)

> If you are creating an Email Account for Email Inbox of a User, then leave Append To field as blank.

Read [Email Account documentation](https://docs.frappe.io/erpnext/email-account) for more details on how to setup.
...
![Email User Link](https://docs.frappe.io/files/email-user-link.png)
...
![Email Folders](https://docs.frappe.io/files/email-folders.png)

### 5.2 Actions

On the emails in your inbox, you can take various actions like Reply, Forward, Mark as Spam or Trash.

![Email Actions](https://docs.frappe.io/files/email-actions.png)
...
![Make from Email](https://docs.frappe.io/files/make-from-email.png)

### 6\. Related Topics

1.  [Email Account](https://docs.frappe.io/erpnext/email-account)
2.  [Sending Email](https://docs.frappe.io/erpnext/sending-email)
