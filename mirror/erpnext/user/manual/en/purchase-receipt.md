...
source_url: https://docs.frappe.io/erpnext/user/manual/en/purchase-receipt
upstream_updated: "18-06-2026 19:59:15"
...
![Purchase Receipt flow](https://docs.frappe.io/files/purchase-receipt-flow.png)
...
![Purchase Receipt Items table](https://docs.frappe.io/files/purchase-receipt-item.png)
...
![Quality Inspection](https://docs.frappe.io/files/quality-inspection.png)
...
-   The **Get Current Stock** button will fetch the current stock of the Consumed Items from the Supplier Warehouse.  
    ![Purchase Receipt](https://docs.frappe.io/files/purchase-receipt-consumed-items.png)
...
Add an **"Allocate Full Amount to Stock Items"** checkbox on _Purchase Taxes and Charges_ rows of type **Actual** (shown only for category Valuation / Valuation and Total).
...
![Purchase Receipt submit](https://docs.frappe.io/files/purchase-receipt-submit.png)
...
will have to use the Landed Cost Voucher. Why “Landed Cost”? Because it represents the charges that you paid when it landed in your possession.
