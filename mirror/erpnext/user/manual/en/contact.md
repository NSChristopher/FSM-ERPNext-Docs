---
title: "Contact | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/contact
upstream_updated: "23-07-2026 17:22:13"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Contact | ERPNext Documentation

A **Contact** represents a person you communicate with. A Contact can be linked to a [Customer](https://docs.frappe.io/erpnext/customer), [Supplier](https://docs.frappe.io/erpnext/supplier), Lead, shareholder, [Sales Partner](https://docs.frappe.io/erpnext/sales-partner), or user—and the same person can be linked to more than one party.
...
The simplest method for a party-specific Contact is to create it beside the party's linked [Addresses](https://docs.frappe.io/erpnext/address):
...
-   Convert or reuse a person from a [Lead](https://docs.frappe.io/erpnext/lead) workflow.
-   Use [Data Import](https://docs.frappe.io/erpnext/data-import) for a controlled batch, including child rows for email IDs, phone numbers, and links.
...
When several Contacts are linked to a party, mark the normal recipient as primary. ERPNext can select that Contact automatically in a [Quotation](https://docs.frappe.io/erpnext/quotation), [Sales Order](https://docs.frappe.io/erpnext/sales-order), [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice), or other supported document.
...
Use **Invite as User** only when the Contact should access the [Customer Portal](https://docs.frappe.io/erpnext/customer-portal) or another permitted portal experience.
