---
title: "Raw Printing"
source_url: https://docs.frappe.io/erpnext/user/manual/en/raw-printing
...
To be able to send raw commands to a printer you need to first create a print format in raw commands. Jinja Templating Language is used in raw commands just like in the [HTML custom print format](https://docs.frappe.io/erpnext/print-format).
...
![Raw Commands Print Format](https://docs.frappe.io/files/raw-command-print-format.png)
...
-   ![QZ Tray Prompt](https://docs.frappe.io/files/qz-tray-prompt.png)
...
-   The printer needs to be installed on your computer to be able to map it to a print format.  
    ![print format - printer mapping](https://docs.frappe.io/files/printer-settings.png)
...
![Raw Printing from Print View](https://docs.frappe.io/files/raw-printing-from-print-view.gif)
...
1.  [Print Settings](https://docs.frappe.io/erpnext/print-settings)
2.  [Print Format](https://docs.frappe.io/erpnext/print-format)
3.  [Print Style](https://docs.frappe.io/erpnext/print-style)
