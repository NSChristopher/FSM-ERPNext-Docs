...
source_url: https://docs.frappe.io/erpnext/user/manual/en/bom-costing-in-different-currency
...
![BOM in different Currency](https://docs.frappe.io/files/bom-currency.png)
...
![BOM in different Currency](https://docs.frappe.io/files/bom-currency-1.png)
