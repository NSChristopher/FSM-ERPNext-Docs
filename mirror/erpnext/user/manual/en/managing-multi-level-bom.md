...
source_url: https://docs.frappe.io/erpnext/user/manual/en/managing-multi-level-bom
...
![Multi-level BOM](https://docs.frappe.io/files/multi-bom.png)
...
![Multi-level BOM](https://docs.frappe.io/files/bom-materials.png)

In the exploded view only the raw materials are shown:  
![Multi-level BOM](https://docs.frappe.io/files/bom-materials-exploded.png)
