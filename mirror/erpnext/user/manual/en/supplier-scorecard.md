...
source_url: https://docs.frappe.io/erpnext/user/manual/en/supplier-scorecard
...
5.  A supplier scorecard is created for each supplier individually. Only one supplier scorecard can be created for each supplier.  
    ![Purchase Order](https://docs.frappe.io/files/supplier-scorecard.png)
...
![Purchase Order](https://docs.frappe.io/files/supplier-scorecard-weighing.png)  
...
![Purchase Order](https://docs.frappe.io/files/supplier-scorecard-standing.png)
...
![Purchase Order](https://docs.frappe.io/files/supplier-scorecard-criteria.png)
...
![Supplier Scorecard variable](https://docs.frappe.io/files/supplier-scorecard-variables.png)
...
2.  [Supplier Quotation](https://docs.frappe.io/erpnext/supplier-quotation)
