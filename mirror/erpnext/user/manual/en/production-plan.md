...
source_url: https://docs.frappe.io/erpnext/user/manual/en/production-plan
upstream_updated: "27-02-2026 17:56:28"
...
2.  Select whether to get items from a [Sales Order](https://docs.frappe.io/erpnext/sales-order) or a [Material Request](https://docs.frappe.io/erpnext/material-request).
...
![Production Plan fetch items](https://docs.frappe.io/files/pp_fetch_from.png)  
2\. Click on Get Sales Orders to fetch sales orders based on the above filters.

![Sales Order Filters](https://docs.frappe.io/files/sales_order_filter.png)  
3\. Click on 'Get Items for Work Order' to fetch the items from the above Sales Orders. Items only for which a BOM is present will be fetched. ![Get items for Production Plan](https://docs.frappe.io/files/get_items_wo.png)  
...
5\. If "Consolidate Items" is ticked and saved, items with the same BOM are combined into a single item with the combined total planned quantity. ![Get items Combined for Production Plan](https://docs.frappe.io/files/get_items_combined_wo.png)
...
![Material Request Filters](https://docs.frappe.io/files/material_request_filter.png)  
2\. Click on 'Get Material Request' to fetch material requests based on the above filters.

![Material Requests](https://docs.frappe.io/files/material_requests.png)  
3\. Click on Get Items for Work Order to fetch the items from the above material requests.

![Material Request Item](https://docs.frappe.io/files/material_request_items.png)

### 2.3 Fetching Sub Assembly Items

Clicking on 'Get Sub Assembly Items' will fetch Sub Assembly Items from the BOM of the Finished Good Items, in the table above. ![Get Sub Assembly Items](https://docs.frappe.io/files/get-subassembly-items.png)
...
![](https://docs.frappe.io/files/Screenshot%202025-04-08%20at%204.43.43%20PM.png)
...
![](https://docs.frappe.io/files/Screenshot%202025-04-08%20at%204.44.08%20PM.png)
...
![Combine Sub Assemby Items](https://docs.frappe.io/files/consolidate-subassembly-items.png)
...
![](https://docs.frappe.io/files/Screenshot%202025-04-08%20at%204.24.08%20PM.png)
...
![](https://docs.frappe.io/files/Screenshot%202025-04-08%20at%204.36.30%20PM.png)
...
![](https://docs.frappe.io/files/Screenshot%202025-04-08%20at%204.42.00%20PM.png)

Use the following checkboxes to perform certain actions:

-   **Include Non Stock Items**: To include non-stock items in the material request planning. i.e. Items for which 'Maintain Stock' checkbox is unticked. Refer the [Item page](https://docs.frappe.io/erpnext/item#12-options-when-creating-an-item) for more details.
...
![](https://docs.frappe.io/files/Screenshot%202025-04-08%20at%204.43.08%20PM.png)
...
![Material Request Plan](https://docs.frappe.io/files/material_request_excel.png)
...
![](https://docs.frappe.io/files/Screenshot%202025-04-08%20at%204.49.56%20PM.png)
...
![Closing a Production Plan](https://docs.frappe.io/files/production_plan_status.gif)
...
2.  [Job Card](https://docs.frappe.io/erpnext/job-card)
