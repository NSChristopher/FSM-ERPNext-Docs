...
source_url: https://docs.frappe.io/erpnext/user/manual/en/cheque-print-template
...
![Sample Cheque](https://docs.frappe.io/files/sample-cheque.jpg)
...
![Sample Cheque](https://docs.frappe.io/files/cheque-1.png)
...
![Sample Cheque](https://docs.frappe.io/files/cheque-2.png)
...
![Sample Cheque](https://docs.frappe.io/files/cheque-3.gif)

### 2\. Related Topics

1.  [Address Template](https://docs.frappe.io/erpnext/address-template)
2.  [Terms and Conditions Template](https://docs.frappe.io/erpnext/terms-and-conditions)
