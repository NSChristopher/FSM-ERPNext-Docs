...
source_url: https://docs.frappe.io/erpnext/user/manual/en/mpesa-integration
...
![Mpesa Credentials](https://docs.frappe.io/files/mpesa_credentials.png)
...
![Mpesa Settings](https://docs.frappe.io/files/mpesa_settings.png)
...
![Mpesa COA](https://docs.frappe.io/files/mpesa_coa.png)  
![Mpesa POS Settings](https://docs.frappe.io/files/mpesa_pos_settings.png)
...
![Payment Gateway Account](https://docs.frappe.io/files/payment_gateway_account_mpesa.png)
...
![POS Additional Information](https://docs.frappe.io/files/additional-information.png)
...
![POS Account Balance](https://docs.frappe.io/files/mpesa_account_balance.png)
