...
source_url: https://docs.frappe.io/erpnext/user/manual/en/perpetual-inventory
upstream_updated: "27-02-2026 17:50:29"
...
1.  Go to:  
    _Home > Accounting > Company > Enable Perpetual Inventory_\*  
    [Perpetual Inventory](https://docs.frappe.io/files/perpetual-1.png)  
...
3.  If the user wants to set an individual account for each warehouse, create account head for each account. Go to:  
    _Accounts > Chart of Accounts > Company > Application of Funds (Assets) > Current Asset > Stock Assets > Create a new account with same name as Warehouse_\*  
...
![Perpetual Inventory](https://docs.frappe.io/files/perpetual-receipt-sl-1.png)

**General Ledger**

![Perpetual Inventory](https://docs.frappe.io/files/perpetual-receipt-gl-2.png)
...
![Perpetual Inventory](https://docs.frappe.io/files/perpetual-pinv-gl-3.png)
...
![Perpetual Inventory](https://docs.frappe.io/files/perpetual-dn-sl-4.png)

**General Ledger**

![Perpetual Inventory](https://docs.frappe.io/files/perpetual-dn-gl-5.png)
...
![Perpetual Inventory](https://docs.frappe.io/files/perpetual-inv-sl-6.png)

**General Ledger**

![Perpetual Inventory](https://docs.frappe.io/files/perpetual-inv-gl-7.png)
...
![Perpetual Inventory](https://docs.frappe.io/files/perpetual-st-receipt-sl.png)

**General Ledger**

![Perpetual Inventory](https://docs.frappe.io/files/perpetual-st-receipt-gl.png)
...
![Perpetual Inventory](https://docs.frappe.io/files/perpetual-st-issue-sl.png)

**General Ledger**

![Perpetual Inventory](https://docs.frappe.io/files/perpetual-st-issue-gl.png)
...
![Perpetual Inventory](https://docs.frappe.io/files/perpetual-st-transfer-sl.png)

**General Ledger**

![Perpetual Inventory](https://docs.frappe.io/files/perpetual-st-transfer-gl.png)

#### 3\. Related Topics

1.  [Accounting Of Inventory Stock](https://docs.frappe.io/erpnext/accounting-of-inventory-stock)
2.  [Migrate to Perpetual Inventory](https://docs.frappe.io/erpnext/migrate-to-perpetual-inventory)
