---
title: "Batch"
source_url: https://docs.frappe.io/erpnext/user/manual/en/batch
upstream_updated: "06-03-2026 11:54:19"
...
-   Enable 'Has Batch No' in the Item master ![Batch No Enabled](https://docs.frappe.io/files/batch-no-enabled.png)
...
When Batches are enabled for an Item, the option to [retain sample stock](https://docs.frappe.io/erpnext/retain-sample-stock) also becomes available.
...
![Item Setup for Batches](https://docs.frappe.io/files/item_setup_for_batch.png)
...
![Batch View](https://docs.frappe.io/files/batch_view.png)
...
![Split Batch](https://docs.frappe.io/files/batch_split.png)
...
1.  [Serial Number](https://docs.frappe.io/erpnext/serial-no)
2.  [Opening Stock Balance Entry For Serialized And Batch Item](https://docs.frappe.io/erpnext/opening-stock-balance-entry-for-serialized-and-batch-item)
3.  [Managing Batch Wise Inventory](https://docs.frappe.io/erpnext/managing-batch-wise-inventory)
