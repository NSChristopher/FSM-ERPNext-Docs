---
title: "Territory | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/territory
upstream_updated: "02-08-2026 17:28:43"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Territory | ERPNext Documentation
...
-   Create the relevant [Item Groups](https://docs.frappe.io/erpnext/item-group), Fiscal Years, and Monthly Distributions before adding targets.
-   Set a Default Territory in [Selling Settings](https://docs.frappe.io/erpnext/selling-settings) if most new Customers should receive the same value.
...
| Territory Manager | A reference to the person responsible for the region. It does not replace user permissions or the [Sales Person](https://docs.frappe.io/erpnext/sales-person) assignment on transactions. |
...
Select the appropriate Territory on the [Customer](https://docs.frappe.io/erpnext/customer) record. The value can then flow into supported sales transactions. A default from Selling Settings helps during Customer creation, including when ERPNext converts a Lead-based [Quotation](https://docs.frappe.io/erpnext/quotation) into a Customer.
...
For more detail about targets and distributions, see [Sales Person Target Allocation](https://docs.frappe.io/erpnext/sales-person-target-allocation). Territory targets can be reviewed using target variance reports in [Sales Reports](https://docs.frappe.io/erpnext/sales-reports).
...
| --- | --- |
| Customer and Address | Classifies the customer or location for regional reporting. See [Address](https://docs.frappe.io/erpnext/address). |
| Sales transactions | Carries the regional classification into documents such as Sales Orders and [Sales Invoices](https://docs.frappe.io/erpnext/sales-invoice). |
