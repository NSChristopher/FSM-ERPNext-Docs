...
source_url: https://docs.frappe.io/erpnext/user/manual/en/promotional-scheme
...
A Promotional Scheme manages one or more discount slabs and generates the corresponding [Pricing Rules](https://docs.frappe.io/erpnext/pricing-rule). Use it when an offer needs several quantity or amount tiers, mixed-item conditions, cumulative purchases, or a discount on another Item.

## Before you begin

Create the required:

-   [Items](https://docs.frappe.io/erpnext/item), Item Groups, or Brands.
-   [Customers](https://docs.frappe.io/erpnext/customer), Customer Groups, Territories, Sales Partners, or Campaigns used as conditions.
-   Selling or buying [Price Lists](https://docs.frappe.io/erpnext/price-lists) and Item Prices.
...
Create a new [Quotation](https://docs.frappe.io/erpnext/quotation) or [Sales Order](https://docs.frappe.io/erpnext/sales-order), select an eligible party, and add Items around each slab boundary.
...
-   [Buy 1 Get 1 Free Pricing Rule](https://docs.frappe.io/erpnext/setting-up-buy-1-get-1-free-pricing-rule)
