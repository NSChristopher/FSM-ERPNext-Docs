...
source_url: https://docs.frappe.io/erpnext/user/manual/en/item-alternative
upstream_updated: "27-02-2026 17:51:52"
...
![Item](https://docs.frappe.io/files/allow-alternative-item.png)
...
![Item Alternative](https://docs.frappe.io/files/item-alternative.png)
...
![Item](https://docs.frappe.io/files/allow-alternative-item-bom.png)
...
![Item](https://docs.frappe.io/files/allow-alternative-item-wo.png)
...
![Item](https://docs.frappe.io/files/work_order_item_alternative.gif)

This is how you use Item Alternative with a Stock Entry:  
![Item](https://docs.frappe.io/files/se_item_alternative.gif)
...
![Item](https://docs.frappe.io/files/purchase_order_item_alternative.gif)
