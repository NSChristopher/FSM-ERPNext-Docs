---
title: "ERPNext Shipping"
source_url: https://docs.frappe.io/erpnext/user/manual/en/erpnext_shipping
upstream_updated: "02-03-2026 16:05:51"
...
![Sendcloud API](https://docs.frappe.io/files/sendcloud_api.png)
...
![LetMeShip API](https://docs.frappe.io/files/letmeship_api.png)
...
Once a [Shipment](https://docs.frappe.io/erpnext/shipment) is submitted, if the app is installed, the button **Fetch Shipping Rates** will appear. On clicking, you will get a list of services along with their service providers and rates.

![Fetch Rates](https://docs.frappe.io/files/fetch_rates.png)
...
![Highlight Service](https://docs.frappe.io/files/service_highlight.png)  
...
![Preferred Service](https://docs.frappe.io/files/preferred_service.png)
...
![Shipment Creation](https://docs.frappe.io/files/create_shipment.gif)
...
![Print Label Button](https://docs.frappe.io/files/print_label_button.png)

You can then click on it and generate your shipping label.

![Dummy Shipping Label](https://docs.frappe.io/files/dummy_shipping_label.png)
