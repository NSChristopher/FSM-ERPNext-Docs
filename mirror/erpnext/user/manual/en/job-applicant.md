---
title: "Job Applicant"
source_url: https://docs.frappe.io/erpnext/user/manual/en/job-applicant
...
You can link Job Application with an Email account. Suppose you link Job Application with an email [\[email protected\]](https://docs.frappe.io/cdn-cgi/l/email-protection#c1abaea381a4b9a0acb1ada4efa2aeac), the system will create a New Job Applicant against each email received on the mailbox.
...
After creating [Interviews](https://docs.frappe.io/hr/interview), you can easily track them within the Job Applicant dashboard. This enables you to compare all the interviews conducted with the applicant and evaluate their overall performance to make an acceptance decision.
