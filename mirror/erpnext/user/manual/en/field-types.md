---
title: "Field Types"
source_url: https://docs.frappe.io/erpnext/user/manual/en/field-types
...
Link field is connected to another master from where it fetches data. For example, in the Quotation master, the Customer is a Link field. To know more, [click here](https://docs.frappe.io/erpnext/creating-custom-link-field).

#### Dynamic Link

Dynamic Link field is one which can search and hold value of any document/doctype. [Click here](https://docs.frappe.io/erpnext/dynamic-link-fields) to learn how Dynamic Link Field functions.

#### Check

This will enable you to have a checkbox here.

![Check Field TYpe](https://docs.frappe.io/files/field-type-check.png)

#### Select

Select will be a drop-down field. You can add multiple results in the Option field, separated by row.

![Select Field Type](https://docs.frappe.io/files/field-type-select.png)
...
![Table Field Type](https://docs.frappe.io/files/field-type-table.png)

#### Attach

Attach field allows you to browse a field from the File Manager and attach the same herein.

![Attach Field Type](https://docs.frappe.io/files/field-type-attach.png)
...
![Field Type Image](https://docs.frappe.io/files/field-type-image.png)
...
![Field Type Text Editor](https://docs.frappe.io/files/field-type-text-editor.png)

#### Date

This field will enable you to enter the Date in this field.

![Field Type Date](https://docs.frappe.io/files/field-type-date.png)
...
![Field Type Date and Time](https://docs.frappe.io/files/field-type-date-and-time.png)
...
![Field Type Barcode](https://docs.frappe.io/files/field-type-barcode.png)

#### Button

This kind of field will be an action button, like Save, Submit, etc.

![Field Type Button](https://docs.frappe.io/files/field-type-button.png)

#### Code

If the Field Type is selected as code, you will be able to enter a Code to the field.

![Field Type Code](https://docs.frappe.io/files/field-type-code.png)

#### Color

You will have the option of specifying the color for this Form.

![Field Type Colour](https://docs.frappe.io/files/field-type-colour.png)
...
![Field Type Column Break](https://docs.frappe.io/files/field-type-column-break.png)
...
![Field Type Currency](https://docs.frappe.io/files/field-type-currency.png)
...
![Field Type Data](https://docs.frappe.io/files/field-type-data.png)

#### Float

Float field carries numeric value, up to nine decimal places. Precision for the float field is set via [Set Precision](https://docs.frappe.io/erpnext/set-precision)

> Setup > Settings > System Settings

The setting will be applicable on all the float field.

![Field Type Float](https://docs.frappe.io/files/field-type-float.png)
...
Read [Geolocation field](https://docs.frappe.io/erpnext/geolocation-field) for more understanding.

![Field Type Geolocation](https://docs.frappe.io/files/field-type-geolocation.png)

#### HTML

You can select the field to be an HTML field when you want the data to be entered in HTML format.

![Field Type HTML](https://docs.frappe.io/files/field-type-html.png)
...
![Field Type Image](https://docs.frappe.io/files/field-type-image2.png)

#### Int (Integer)

The integer field holds numeric value, without decimal place.

![Field Type Integer](https://docs.frappe.io/files/field-type-integer.png)

#### Small Text

Small Text field carries text content and has more character limit than the Data field.

![Field Type Small Text](https://docs.frappe.io/files/field-type-small-text.png)

#### Long Text

You can define your field to a Long Text Field when you would want to enter data with an unlimited character limit.

![Field Type Long Text](https://docs.frappe.io/files/field-type-long-text.png)
...
![Field Type Text](https://docs.frappe.io/files/field-type-text.png)

#### Markdown Editor

This field will allow you to add the text in Markup language.

![Field Type Markdown Editor](https://docs.frappe.io/files/field-type-markdown-editor.png)

#### Password

The password field will have decoded value in it.

![Field Type Password](https://docs.frappe.io/files/field-type-password.png)

#### Percent

You can define the field as a Percentage field which in the background will be calculated as a percentage.

![Field Type Percent](https://docs.frappe.io/files/field-type-percent.png)

#### Rating

You can define the field as a Rate field which in the background will be calculated as Rating.

![Field Type Rating](https://docs.frappe.io/files/field-type-rating.png)
...
![Field Type Read Only](https://docs.frappe.io/files/field-type-read-only.png)

#### Section Break

Section Break is used to divide the form into multiple sections.

![Field Type Section Break](https://docs.frappe.io/files/field-type-section-break.png)

#### Signature

You can define the field to be a Signature field wherein you can add the Digital Signature in this field.

![Screenshot 2024-08-28 at 3.01.56 PM](https://docs.frappe.io/files/Screenshot%202024-08-28%20at%203.01.56%20PM.png)
...
![Field Type Table MultiSelect](https://docs.frappe.io/files/field-type-table-multiselect.png)

#### Time

This is a Time field where you can define the Time in the field.

![Field Type Time](https://docs.frappe.io/files/field-type-time.png)

#### Duration

You can use the Duration field if you want to define a timespan.

![Field Type Duration](https://docs.frappe.io/files/field-type-duration.png)
...
![Field Type Duration Options](https://docs.frappe.io/files/field-type-duration-options.png)

This is how the duration field looks after the above changes.

![Field Type Duration](https://docs.frappe.io/files/field-type-duration2.png)
