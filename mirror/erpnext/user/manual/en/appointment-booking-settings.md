---
title: "Appointment Booking Settings | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/appointment-booking-settings
upstream_updated: "23-07-2026 22:47:53"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Appointment Booking Settings | ERPNext Documentation

You can find all settings related to booking appointments in Appointment Booking Settings.

![Appointment Booking Settings](https://docs.frappe.io/files/appointment-booking-settings.png)

## Enable Appointment scheduling

This checkbox will enable appointment scheduling and also enable the /book\_appointment Route for website users (your customers). Your customers will see a portal view. To know more, visit the [Appointment Page](https://docs.frappe.io/erpnext/appointment)
...
You can link a (holiday list)[\[https://erpnext.com/docs/v13/user/manual/en/human-resources/holiday-list\]](https://erpnext.com/docs/v13/user/manual/en/human-resources/holiday-list%5D) here to apply to the appointment schedule. If the day is a holiday, scheduling an appointment on that day won't be allowed.
...
### Number of days appointment can be books in advance
...
Leave blank for home. This is relative to site URL, for example "about" will redirect to "[https://yoursitename.com/about](https://yoursitename.com/about)"
