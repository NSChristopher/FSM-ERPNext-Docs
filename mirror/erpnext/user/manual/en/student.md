---
title: "Student"
source_url: https://docs.frappe.io/erpnext/user/manual/en/student
upstream_updated: "09-02-2026 18:02:45"
...
The student is enrolled in a [Program](https://docs.frappe.io/education/program) when the application is approved. Once the enrollment is done the [Student Applicant](https://docs.frappe.io/education/student-applicant) status is update to Admitted.
...
The details of the student's guardian and their relationship with the student can be captured here. You can create a [Guardian](https://docs.frappe.io/education/guardian) from here itself, or create a guardian first and then create the Student.
