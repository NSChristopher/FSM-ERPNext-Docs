---
title: "Set Language | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/set-language
upstream_updated: "15-08-2026 18:01:49"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Set Language | ERPNext Documentation
...
-   [Translations](https://docs.frappe.io/erpnext/translations)
-   [Country](https://docs.frappe.io/erpnext/country)
-   [Global Defaults](https://docs.frappe.io/erpnext/global-defaults)
-   [Print Format](https://docs.frappe.io/erpnext/print-format)
