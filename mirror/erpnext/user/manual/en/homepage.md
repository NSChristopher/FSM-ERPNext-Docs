---
title: "Homepage"
source_url: https://docs.frappe.io/erpnext/user/manual/en/homepage
...
![Homepage](https://docs.frappe.io/files/homepage.png)  
_Homepage_
...
![Website Homepage](https://docs.frappe.io/files/website-homepage.png)  
_Website Homepage_
...
![Homepage Slideshow Setting](https://docs.frappe.io/files/homepage-slideshow-setting.png)  
_Homepage Slideshow Setting_

Now, select an existing Slideshow or create a new one shown as follows:

![Website Slideshow](https://docs.frappe.io/files/website-slideshow.png)  
_Website Slideshow_

> For best results, make sure all of your slideshow images have same height and  
> their width is greater than the height.

![Website Homepage with Slideshow](https://docs.frappe.io/files/website-homepage-slideshow.gif)
...
![Homepage Settings](https://docs.frappe.io/files/homepage-hero-custom.png)  
_Homepage Settings_

You can write any valid [Bootstrap 4](https://getbootstrap.com/) markup here.

![New Hero Section](https://docs.frappe.io/files/hero-custom.png)  
_New Hero Section_

It will look something like this:  
![Homepage Hero Custom](https://docs.frappe.io/files/website-homepage-custom.png)  
_Homepage Hero Custom_
...
![Homepage Products Table](https://docs.frappe.io/files/homepage-featured-products.png)  
_Homepage Products Table_

It will look something like this:  
![Featured Products on Homepage](https://docs.frappe.io/files/website-featured-products.png)  
_Featured Products on Homepage_
...
![New Homepage Section](https://docs.frappe.io/files/new-homepage-section.png)  
_New Homepage Section_

Add details for each card like Title, Subtitle, Image, Content and Route in the  
Section Cards table.

It will look something like this:  
![Homepage Section](https://docs.frappe.io/files/homepage-section.png)  
_Homepage Section_
...
1.  Create a [Web Page](https://docs.frappe.io/erpnext/web-page).
2.  Go to Website > Setup > Website Settings.
3.  Set Home Page as the `route` of your Web Page.  
    ![](https://docs.frappe.io/files/custom-homepage.png)
