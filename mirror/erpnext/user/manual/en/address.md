---
title: "Address | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/address
upstream_updated: "23-07-2026 17:22:13"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Address | ERPNext Documentation

An **Address** stores a physical or mailing location and can be linked to a [Customer](https://docs.frappe.io/erpnext/customer), [Supplier](https://docs.frappe.io/erpnext/supplier), Lead, shareholder, sales partner, [Warehouse](https://docs.frappe.io/erpnext/warehouse), or Company. One party can have several billing, shipping, office, and branch addresses.
...
The selected Country determines the country-specific [Address Template](https://docs.frappe.io/erpnext/address-template) used when ERPNext renders the address.
...
-   Use [Data Import](https://docs.frappe.io/erpnext/data-import) for a controlled batch and include the correct Dynamic Link rows.
...
A preferred billing Address can be fetched into [Sales Orders](https://docs.frappe.io/erpnext/sales-order), [Sales Invoices](https://docs.frappe.io/erpnext/sales-invoice), [Delivery Notes](https://docs.frappe.io/erpnext/delivery-note), purchase documents, and other supported transactions. The preferred shipping Address supplies the normal delivery destination.
...
For your own facilities, enable **Is Your Company Address** and link the [Company](https://docs.frappe.io/erpnext/company). Verify regional requirements against the installed compliance app and current law.
...
-   select it on a test [Quotation](https://docs.frappe.io/erpnext/quotation) or transaction;
...
-   [Address Template](https://docs.frappe.io/erpnext/address-template)
