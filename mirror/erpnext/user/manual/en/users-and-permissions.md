---
title: "Adding Users"
source_url: https://docs.frappe.io/erpnext/user/manual/en/users-and-permissions
upstream_updated: "29-03-2026 15:21:59"
...
Read more about [difference between system and website user](https://docs.frappe.io/erpnext/difference-between-system-user-and-website-user).
...
![](https://docs.frappe.io/files/imagef073c4.png)  
_Details like Username and Language can also be changed._
...
With this option you can follow various documents in the system and get email notifications when they are updated. Know more [here](https://docs.frappe.io/erpnext/document-follow).
...
-   **Email Signature**: Adding an email signature here will set it as default for all outgoing emails for the user. This is different from a footer which is set from the [Company master](https://docs.frappe.io/erpnext/company-setup).

### 2.6 Email Inbox

Subscribe the user to different mailing lists of your company from this section. Add a new row and select the mailing list to assign this user. For example, mailing lists can be jobs, support, sales, etc. To know more about Email Inbox, [click here](https://docs.frappe.io/erpnext/email-inbox).
...
![](https://docs.frappe.io/files/image6d7bb1.png)
...
![](https://docs.frappe.io/files/image9fc1f4.png)

#### Permissions

-   **Set User Permissions**: Will take you to the [User Permissions](https://docs.frappe.io/erpnext/user-permissions) page of Bruce from where you can restrict Bruce's access to documents.
...
-   **Reset Password**: An email with instructions to reset the user's password will be sent to the user's [Email Account](https://docs.frappe.io/erpnext/email-account).
-   **Reset OTP Secret**: Reset OTP Secret for logging in via Two Factor Authentication.

Create User Email will let you create an [Email Account](https://docs.frappe.io/erpnext/email-account) for the user based on the email entered in the User master.
...
![Email Login](https://docs.frappe.io/files/user-login-email.png)

  

Login with Email or Mobile:

![Mobile No Login](https://docs.frappe.io/files/user-login-mobile.png)
...
1.  [Role Based Permissions](https://docs.frappe.io/erpnext/role-based-permissions)
2.  [User Permissions](https://docs.frappe.io/erpnext/user-permissions)
3.  [Document Follow](https://docs.frappe.io/erpnext/document-follow)
