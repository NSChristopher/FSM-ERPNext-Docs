---
title: "Access Log"
source_url: https://docs.frappe.io/erpnext/user/manual/en/access-log
upstream_updated: "04-03-2026 16:51:56"
...
![Access Log](https://docs.frappe.io/files/using-access-log-3.png)
...
![Access Log](https://docs.frappe.io/files/using-access-log-1.png)
...
![Access Log](https://docs.frappe.io/files/using-access-log-2.png)

Events such as [Raw Printing](https://docs.frappe.io/erpnext/raw-printing) save information along with the chosen template for the document.

![Access Log](https://docs.frappe.io/files/using-acces-log-4.png)
