...
source_url: https://docs.frappe.io/erpnext/user/manual/en/uom
...
In the UoM there is an option 'Must be Whole Number'. If this is checked, you cannot use fraction numbers in this UoM. To know more about fractions and UoMs, check out [this page](https://docs.frappe.io/erpnext/managing-fractions-in-uom).
...
![](https://docs.frappe.io/files/uom-conversion.png)
