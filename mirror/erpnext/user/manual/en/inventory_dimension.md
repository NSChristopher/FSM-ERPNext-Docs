...
source_url: https://docs.frappe.io/erpnext/user/manual/en/inventory_dimension
...
![new inventory dimension](https://docs.frappe.io/files/new-inventory-dimension.png)
...
![inventory dimension applicable for all inventory documents](https://docs.frappe.io/files/inventory-dimension-applicable-for-all-inventory-documents.png)
...
![inventory dimension applicable for](https://docs.frappe.io/files/inventory-dimension-applicable-for.png)
...
![](https://docs.frappe.io/files/463173872-b10fbcaf-4851-43f0-bcfe-ff1dd2d2ec73.png)

## Use of Inventory Dimension

![inventory dimension on transaction](https://docs.frappe.io/files/inventory-dimension-on-transaction.png)
...
![](https://docs.frappe.io/files/fqvxY3m.png)
...
![](https://docs.frappe.io/files/OKgkIqS.png)
...
![inventory dimension stock balance](https://docs.frappe.io/files/inventory-dimension-stock-balance.png)

### Stock Ledger Report

![inventory dimension stock ledger](https://docs.frappe.io/files/inventory-dimension-stock-ledger.png)
...
![](https://docs.frappe.io/files/cTOHcyI.png)
