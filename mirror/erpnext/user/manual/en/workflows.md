---
title: "Workflows"
source_url: https://docs.frappe.io/erpnext/user/manual/en/workflows
upstream_updated: "02-03-2026 23:35:36"
...
Once a Workflow is created, you can take actions on it via [Workflow Actions](https://docs.frappe.io/erpnext/workflow-actions).
...
![Workflow](https://docs.frappe.io/files/workflow.png)  
4\. Enter the Transition Rules.

![Workflow Transition Rules](https://docs.frappe.io/files/workflow-transition-rules.png)
...
E.g. states like Canceled or Rejected can be optional. ![Optional State](https://docs.frappe.io/files/workflow-optional-state.png)
...
![Workflow State in Transaction](https://docs.frappe.io/files/workflow-status-in-transaction.png)
...
![Workflow Action Options](https://docs.frappe.io/files/workflow-action-options.png)

When the Regional Manager opens the quotation, he can finally "Approve" or "Reject" it.

![Workflow Action Options](https://docs.frappe.io/files/workflow-action-options-2.png)
...
1.  [Workflow Actions](https://docs.frappe.io/erpnext/workflow-actions)
