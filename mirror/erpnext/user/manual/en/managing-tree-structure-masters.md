...
source_url: https://docs.frappe.io/erpnext/user/manual/en/managing-tree-structure-masters
...
![Default Territories](https://docs.frappe.io/files/territory-2.png)
...
![Default Territories](https://docs.frappe.io/files/territory-1.gif)

Following is how Child Territories will be listed under a Parent Territory.

![Adding new Territories](https://docs.frappe.io/files/territory-3.png)
