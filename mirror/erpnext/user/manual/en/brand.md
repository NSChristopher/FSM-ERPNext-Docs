---
title: "Brand"
source_url: https://docs.frappe.io/erpnext/user/manual/en/brand
...
3.  Save.  
    [Brand](https://docs.frappe.io/files/brand.png)

Now this Brand can be associated with different Items.

![](https://docs.frappe.io/files/item_brand.png)

## 2\. Features

### 2.1 Setting defaults for Items of this Brand

![](https://docs.frappe.io/files/brand_defaults.png)
...
2.  [Sales Order](https://docs.frappe.io/erpnext/sales-order)
3.  [Purchase Receipt](https://docs.frappe.io/erpnext/purchase-receipt)
4.  [Delivery Note](https://docs.frappe.io/erpnext/delivery-note)
5.  [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice)
6.  [Purchase Invoice](https://docs.frappe.io/erpnext/purchase-invoice)
