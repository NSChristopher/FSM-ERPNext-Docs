...
source_url: https://docs.frappe.io/erpnext/user/manual/en/restore-deleted-erpnext
...
![Restore Deleted Document](https://docs.frappe.io/files/using-restore-1.png)

For bulk deletion, you can select multiple Cancelled records and delete them at once from the List View.

![Restore Deleted Documents](https://docs.frappe.io/files/using-restore-3.gif)
...
![Restore Deleted Document](https://docs.frappe.io/files/using-restore-2.gif)
