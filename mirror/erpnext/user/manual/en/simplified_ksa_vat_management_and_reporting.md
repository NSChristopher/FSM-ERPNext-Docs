...
source_url: https://docs.frappe.io/erpnext/user/manual/en/simplified_ksa_vat_management_and_reporting
...
![image-20210819234431755](https://docs.frappe.io/files/image-20210819234431755.png)
...
![image-20210819233134033](https://docs.frappe.io/files/image-20210819233134033.png)
...
![image-20210819233839064](https://docs.frappe.io/files/image-20210819233839064.png)

Use the Item Tax Templates in the Sales and Purchase Invoice. The data should result in a similar KSA VAT Report

![image-20210819235844178](https://docs.frappe.io/files/image-20210819235844178.png)

KSA VAT Invoice - Print Format for Sales Invoice

![ksa-vat-invoice-a4-page-1](https://docs.frappe.io/files/ksa-vat-invoice-page-112b65a.jpg)  
![ksa-vat-invoice-a4-page-2](https://docs.frappe.io/files/ksa-vat-invoice-page-291464f.jpg)
