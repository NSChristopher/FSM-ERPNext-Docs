...
source_url: https://docs.frappe.io/erpnext/user/manual/en/braintree-integration
...
![Braintree Settings](https://docs.frappe.io/files/braintree_account.png)
...
![Braintree COA](https://docs.frappe.io/files/braintree_coa.png)
...
![Payment Gateway Account](https://docs.frappe.io/files/payment_gateway_account_braintree.png)
