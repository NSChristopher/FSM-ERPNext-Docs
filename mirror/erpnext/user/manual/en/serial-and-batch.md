...
source_url: https://docs.frappe.io/erpnext/user/manual/en/serial-and-batch
upstream_updated: "06-03-2026 11:55:39"
...
-   [Serial Number](https://docs.frappe.io/erpnext/user/manual/en/serial-no)
-   [Serial Number Naming](https://docs.frappe.io/erpnext/user/manual/en/serial-no-naming)
...
-   [Serial Number Naming](https://docs.frappe.io/erpnext/user/manual/en/serial-no-naming)
-   [Installation Notes](https://docs.frappe.io/erpnext/user/manual/en/installation-note)
-   [Managing Batch Wise Inventory](https://docs.frappe.io/erpnext/user/manual/en/managing-batch-wise-inventory)
