...
source_url: https://docs.frappe.io/erpnext/user/manual/en/google_contacts
upstream_updated: "28-02-2026 12:37:13"
...
![](https://docs.frappe.io/files/google_contacts_create_contact.gif)

It will be shown in Google Contacts:  
![](https://docs.frappe.io/files/google_contacts_create_contact_!.gif)
...
-   Once Google Contacts Integration is succesful, all the contacts in Google Contacts will be synced if `Pull from Google Contacts` is checked.  
    ![](https://docs.frappe.io/files/google_contacts_contact_sync.gif)
