---
title: "Putaway Rule"
source_url: https://docs.frappe.io/erpnext/user/manual/en/putaway-rule
upstream_updated: "27-02-2026 17:51:59"
...
1.  Go to the Putaway Rule list, click on New.  
    ![Unsaved Putaway Rule](https://docs.frappe.io/files/unsaved-putaway-rule.png)
...
4.  Set the Capacity. You can also select a UOM if you want to set the Capacity in a different UOM. The Capacity in Stock UOM will be set automatically.  
    ![Multi UOM Putaway Rule](https://docs.frappe.io/files/multi-uom-putaway-rule.png)
...
![Apply Putaway Rule checkbox](https://docs.frappe.io/files/apply-putaway-rule.png)
...
1.  Here is a Purchase Order with a requirement of 5 Cartons (60 Nos) of Mineral Water.  
    ![Purchase Order](https://docs.frappe.io/files/po-putaway-demo.png)
...
2.  Two active Putaway Rules have been created below with capacity 4 Cartons (48 Nos) each. One has a higher priority than the other.  
    ![Active Putaway Rules List](https://docs.frappe.io/files/active-putaway-rules-list.png)
...
4.  On checking **Apply Putaway Rule**, one row of 5 Cartons is split and assigned according to the rules.  
    ![Putaway Rules applied in a Purchase Receipt](https://docs.frappe.io/files/pr-putaway-apply.gif)
...
![Warehouse Capacity Summary](https://docs.frappe.io/files/warehouse-capacity-summary.png)
