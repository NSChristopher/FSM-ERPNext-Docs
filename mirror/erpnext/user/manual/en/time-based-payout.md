...
source_url: https://docs.frappe.io/erpnext/user/manual/en/time-based-payout
...
-   [Sales Invoice from Timesheet](https://docs.frappe.io/erpnext/user/manual/en/sales-invoice-from-timesheet)
-   [Salary Slip from Timesheet](https://docs.frappe.io/erpnext/user/manual/en/salary-slip-from-timesheet)
