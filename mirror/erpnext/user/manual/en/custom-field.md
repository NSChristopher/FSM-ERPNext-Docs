---
title: "Custom Field"
source_url: https://docs.frappe.io/erpnext/user/manual/en/custom-field
upstream_updated: "02-03-2026 12:45:03"
...
You can go to [Customize Form](https://docs.frappe.io/erpnext/customize-form) and add the Field in a particular Form or a Document type _(hereafter referred to as DocType)_ .
...
![New Custom Field](https://docs.frappe.io/files/new-custom-field.png)

_Learn more about Field types_ [_here_](https://docs.frappe.io/erpnext/field-types.html)_._

You can also go to [Customize Form](https://docs.frappe.io/erpnext/customize-form) and add, edit or remove a Field in a particular Form.

![Add Custom Field From Customize Form](https://docs.frappe.io/files/customize-erpnext-custom-field-from-customize-form.gif)
...
![Custom Field with Fieldtype as Select](https://docs.frappe.io/files/custom-field-with-select-fieldtype.png)  
...
![Depends On Option](https://docs.frappe.io/files/custom-field-dpends-on.png)  
6\. **Field Description**: You can add the description of the Field here which can be displayed below this Field.

![Custom Field Description](https://docs.frappe.io/files/custom-field-description.png)  
7\. **Permission Level**: This will allow you to specify which roles within your organization will be able to edit this Field. You can go through [Role Based Permissions](https://docs.frappe.io/erpnext/role-based-permissions) for more understanding on this.  
8\. **In Preview**: If [Show Preview Popup](https://docs.frappe.io/erpnext/customize-form#13-more-properties) for the document type is checked, the Field will be included in the popup that appears on hovering over links of the document type (in list view and other link fields).  
...
-   **Translatable**: When this box is checked, it becomes translatable while applying [Custom Translations](https://docs.frappe.io/erpnext/custom-translations) to this.
...
![](https://docs.frappe.io/files/a7pvD6Y.png)
