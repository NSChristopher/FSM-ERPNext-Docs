---
title: "Request Raw Materials from a Sales Order | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/request-for-raw-materials-from-sales-order
upstream_updated: "25-07-2026 09:07:53"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Request Raw Materials from a Sales Order | ERPNext Documentation

Create a [Material Request](https://docs.frappe.io/erpnext/material-request) directly from one submitted [Sales Order](https://docs.frappe.io/erpnext/sales-order) when you need to procure raw materials for its manufactured Items. Use a [Production Plan](https://docs.frappe.io/erpnext/production-plan) when planning several Sales Orders or broader production demand together.
...
-   Each manufactured Item has an active default [Bill of Materials](https://docs.frappe.io/erpnext/bill-of-materials).
...
| Manufacture and operations must be scheduled | Production Plan and [Work Orders](https://docs.frappe.io/erpnext/work-order) |
...
No. It creates a Material Request. Continue through your procurement workflow to create a [Request for Quotation](https://docs.frappe.io/erpnext/request-for-quotation) or [Purchase Order](https://docs.frappe.io/erpnext/purchase-order).
...
-   [Production Plan](https://docs.frappe.io/erpnext/production-plan)
