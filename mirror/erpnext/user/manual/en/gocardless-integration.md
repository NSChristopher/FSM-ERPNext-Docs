...
source_url: https://docs.frappe.io/erpnext/user/manual/en/gocardless-integration
...
![GoCardless Settings](https://docs.frappe.io/files/gocardless_account.png)
...
![GoCardless COA](https://docs.frappe.io/files/gocardless_coa.png)
...
![Payment Gateway Account](https://docs.frappe.io/files/payment_gateway_account_gocardless.png)
