...
source_url: https://docs.frappe.io/erpnext/user/manual/en/employee-incentive
...
5.  Select the [Salary Component](https://docs.frappe.io/hr/salary-component) under which you want to give the incentive.
6.  Save and Submit.
