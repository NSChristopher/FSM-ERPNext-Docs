...
source_url: https://docs.frappe.io/erpnext/user/manual/en/serial-no-naming
...
![Serial Nos Entry](https://docs.frappe.io/files/serial-naming-1.png)

Generated Serial numbers will be updated for each item.

![Serial Nos Created](https://docs.frappe.io/files/serial-naming-2.png)
...
![Serial Nos Created](https://docs.frappe.io/files/serial-naming-3.png)
...
![Serial Nos Created](https://docs.frappe.io/files/serial-naming-4.png)
