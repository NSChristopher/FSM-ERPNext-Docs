...
source_url: https://docs.frappe.io/erpnext/user/manual/en/strongsales-invoice-without-an-item-strong
...
ERPNext can invoice a one-time charge without selecting an Item Code. Enter the required details directly in the Sales Invoice Items child row. Use this sparingly because an [Item](https://docs.frappe.io/erpnext/item) provides better reporting, tax, UOM, income-account, and pricing consistency.

## Before you begin

Confirm:

-   The [Customer](https://docs.frappe.io/erpnext/customer), Company, currency, and receivable account.
-   The correct Income Account, Cost Center, UOM, and tax treatment for the charge.
-   Whether your organization's controls require an Item master for every invoice line.
-   Permission to create and submit a [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice).

Create a non-stock service or charge Item instead when the same charge is likely to recur.
...
2.  Create a Return or [Credit Note](https://docs.frappe.io/erpnext/credit-note).
...
-   It has a standard [Item Price](https://docs.frappe.io/erpnext/item-price).
-   It appears in Quotations or [Sales Orders](https://docs.frappe.io/erpnext/sales-order).
