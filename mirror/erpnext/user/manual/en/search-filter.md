---
title: "Search Filter"
source_url: https://docs.frappe.io/erpnext/user/manual/en/search-filter
...
![Search Filter](https://docs.frappe.io/files/using-search-filer-1.png)
...
![Search Filter](https://docs.frappe.io/files/using-search-filter-2.png)
...
![Search Filter](https://docs.frappe.io/files/using-search-filter-3.png)
...
![Search Filter](https://docs.frappe.io/files/using-search-filter.gif)

You can also apply multiple filters at a time. To remove a specific filter, just click on 'x' sign on it.

## Default Filters

There are some filters present out of the box for the views which can be used for filtering the search results. The default filters for any Document Type can be set from [Customize Form](https://docs.frappe.io/docs/v13/user/manual/en/customize-erpnext/custom-field#12-more-properties) option.

![Search Filter](https://docs.frappe.io/files/using-search-filter-4.png)

## See also

1.  [Filter by](https://docs.frappe.io/docs/v13/user/manual/en/using-erpnext/filter-by)
2.  [Save Filter](https://docs.frappe.io/docs/v13/user/manual/en/using-erpnext/save-filter)
