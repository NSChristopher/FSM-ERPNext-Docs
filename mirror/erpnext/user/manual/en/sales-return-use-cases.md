---
title: "Sales Return | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/sales-return-use-cases
upstream_updated: "29-07-2026 22:54:55"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Sales Return | ERPNext Documentation
...
1.  Open the original submitted Delivery Note.  
    ...
    \[inline image omitted from mirror: Submitted Delivery Note with the Create button highlighted.\]
    
2.  Select **Create > Sales Return**.  
    
    \[inline image omitted from mirror: Create menu with Sales Return highlighted.\]
    
3.  Review the Customer, return warehouse, posting date, items, and rates fetched from the original document.  
    
    \[inline image omitted from mirror: Return Delivery Note with Is Return and Return Against Delivery Note highlighted.\]
...
\[inline image omitted from mirror: Return Delivery Note items showing negative quantities and the row edit pencil highlighted.\]
...
\[inline image omitted from mirror: Submitted return Delivery Note linked to its original transaction.\]

## Create a return from a Sales Invoice

1.  Open the original submitted Sales Invoice.  
    
    \[inline image omitted from mirror: Submitted Sales Invoice with the Create button highlighted.\]
    
2.  Select **Create > Return / Credit Note**.  
    
    \[inline image omitted from mirror: Create menu with Return or Credit Note highlighted.\]
...
5.  Enable **Update Stock** only when the goods must be received into stock through this Credit Note.  
    ...
    \[inline image omitted from mirror: Credit Note with Is Return, Return Against, and Update Stock highlighted.\]
...
\[inline image omitted from mirror: Credit Note items with negative quantities and the row edit pencil highlighted.\]

  

\[inline image omitted from mirror: Credit Note item row with the negative return quantity highlighted.\]
