...
source_url: https://docs.frappe.io/erpnext/user/manual/en/change-custom-field-datatype-after-field-creation
...
![Select Docytpe](https://docs.frappe.io/files/customize-custom-link-field.gif)
...
![Enter Values](https://docs.frappe.io/files/customize-creating-custom-link-fields.png)
...
You'll notice an action icon on all Link Fields within a Doctype, which gives you the option to select the filters you want to apply.![1](https://docs.frappe.io/files/1.png "1.png")
...
![4](https://docs.frappe.io/files/4.png "4.png")
...
![Screenshot 2024-03-14 at 11.25.07 PM](https://docs.frappe.io/files/Screenshot%202024-03-14%20at%2011.25.07%20PM.png)
...
![Screenshot 2024-03-19 at 12.28.35 PM](https://docs.frappe.io/files/Screenshot%202024-03-19%20at%2012.28.35%20PM.png)
