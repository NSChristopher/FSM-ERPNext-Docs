...
source_url: https://docs.frappe.io/erpnext/user/manual/en/sales-persons-in-the-sales-transactions
...
Use the **Sales Team** table to attribute a sales transaction to one or more [Sales Persons](https://docs.frappe.io/erpnext/sales-person). ERPNext uses each person's Contribution (%) to calculate their contribution to the transaction's Net Total and to populate salesperson reports.

## Before you begin

Create the required:

-   [Sales Person hierarchy](https://docs.frappe.io/erpnext/sales-person).
-   Employees linked to Sales Persons when employee attribution is required.
-   [Customer](https://docs.frappe.io/erpnext/customer) records and sales transactions.
...
The Sales Team table is available in supported transactions such as a [Quotation](https://docs.frappe.io/erpnext/quotation), [Sales Order](https://docs.frappe.io/erpnext/sales-order), [Delivery Note](https://docs.frappe.io/erpnext/delivery-note), and [Sales Invoice](https://docs.frappe.io/erpnext/sales-invoice).
...
Use [Sales Person Target Allocation](https://docs.frappe.io/erpnext/sales-person-target-allocation) and target-variance reports when planned quantity or revenue must be compared with actual sales.
...
For internal incentive calculations, see [Calculate Incentive for Sales Team](https://docs.frappe.io/erpnext/calculate-incentive-for-sales-team). For an external reseller or referral partner, use a [Sales Partner](https://docs.frappe.io/erpnext/sales-partner) and [Sales Partner Commission](https://docs.frappe.io/erpnext/how-to-give-commission-to-sales-partner).
...
-   [Calculate Incentive for Sales Team](https://docs.frappe.io/erpnext/calculate-incentive-for-sales-team)
-   [Sales Partner Commission](https://docs.frappe.io/erpnext/how-to-give-commission-to-sales-partner)
-   [Sales Reports](https://docs.frappe.io/erpnext/sales-reports)
