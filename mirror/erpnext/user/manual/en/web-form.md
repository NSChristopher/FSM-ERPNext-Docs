---
title: "Web Forms"
source_url: https://docs.frappe.io/erpnext/user/manual/en/web-form
upstream_updated: "28-02-2026 15:38:36"
...
![New Web Form](https://docs.frappe.io/files/new-web-form-1.png) _New Web Form_
...
![Web Form Fields](https://docs.frappe.io/files/new-web-form-2.png) _Web Form Fields_

Click on **See on Website** in the sidebar to view your Web form. ![Web Form](https://docs.frappe.io/files/web-form.png) _Web Form_
...
![Web Form Sidebar](https://docs.frappe.io/files/web-form-sidebar.png) _Web Form Sidebar_

![Web Form with Sidebar](https://docs.frappe.io/files/web-form-with-sidebar.png) _Web Form with Sidebar_

### 2.2 Creating Web Forms with Child Table

You can add child tables to your web forms, just like regular forms.

![Web form Grid](https://docs.frappe.io/files/grid-in-webform.png)
...
![Web form payment](https://docs.frappe.io/files/payment-in-webform.png)
...
![Disallow Desk Access](https://docs.frappe.io/files/disallow_desk_access.png)
...
![Success Message](https://docs.frappe.io/files/success_message.png)
