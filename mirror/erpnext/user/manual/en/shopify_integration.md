...
source_url: https://docs.frappe.io/erpnext/user/manual/en/shopify_integration
upstream_updated: "02-03-2026 16:08:44"
...
The repository for app is hosted on GitHub: [http://github.com/frappe/ecommerce\_integrations/](https://github.com/frappe/ecommerce_integrations/)
...
1.  Click on Apps in menu bar  
    ![Menu Section](https://docs.frappe.io/files/app_menu.png)
    
2.  Click on **Develop apps for your store** to create custom app  
    ![new app](https://docs.frappe.io/files/develop%20new%20app.png)
    
3.  Create New app  
    ![](https://docs.frappe.io/files/new_app.png)
    
4.  Fill up the details and create app. The each app has its own API key, Password and Shared secret  
    ![](https://docs.frappe.io/files/configure_admin_scope.png)
...
![](https://docs.frappe.io/files/final_admin_scopes.png)

6.  Install the app on your site  
    ![](https://docs.frappe.io/files/install.png)
...
1.  Fill-up Shopify site URL, Access Token and API Secret from Shopify's Private App.  
    ![](https://docs.frappe.io/files/tokens.png)  
    ![](https://docs.frappe.io/files/Screenshot%202022-02-16%20at%2011.57.34%20AM.png)
    
2.  Setup Customer, Company and Inventory configurations.
    

![Shopify setting page](https://docs.frappe.io/files/main-settings.png)
...
3.  Setup Sync Configurations.  
    ...
    ![Shopify sync config for orders](https://docs.frappe.io/files/series-setting.png)
...
4.  Setup Tax Mapper.  
    ...
    ![Shopify tax mapping](https://docs.frappe.io/files/tax-mapping.png)  
    ![Finding Shopify Tax names](https://docs.frappe.io/files/shopify-tax-names.png)
...
2.  Enter the From and To dates between which the orders need to be synced  
    ![shopify sync old orders](https://docs.frappe.io/files/sync-old-orders.png)
...
![Inventory sync with shopify](https://docs.frappe.io/files/inventory-sync.png)
