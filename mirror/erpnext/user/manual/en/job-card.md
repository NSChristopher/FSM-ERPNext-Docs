---
title: "Job Card"
source_url: https://docs.frappe.io/erpnext/user/manual/en/job-card
upstream_updated: "20-05-2026 14:22:07"
...
![Work Order](https://docs.frappe.io/files/manufacturing-flow-jc.png)
...
![Job Card](https://docs.frappe.io/files/job-card.png)
...
In a Work Order, the Operations and Workstations are fetched from the BOM of an Item. For ease of use, you should ensure that the [Routing](https://docs.frappe.io/erpnext/routing) is configured in the BOM.
...
![Create Shareholder](https://docs.frappe.io/files/work-order-job-card-creation.gif)
...
![Create Shareholder](https://docs.frappe.io/files/work-order-transfer-against-job-card.png)
...
![Create Shareholder](https://docs.frappe.io/files/job-card-form.png)
...
![Create Shareholder](https://docs.frappe.io/files/material-request-against-job-card.png)
...
![Work Order Job Card Completion](https://docs.frappe.io/files/work-order-job-card-completion.png)
...
![Work Order Job Card Completion](https://docs.frappe.io/files/job_card_scrap_item.png)
...
![Quality Inspection Against Job Card](https://docs.frappe.io/files/qi-against-job-card.png)

![Quality Inspection link in Job Card](https://docs.frappe.io/files/qi-link-in-job-card.png)
...
For more details, refer the [Quality Inspection](https://docs.frappe.io/erpnext/quality-inspection) page.
