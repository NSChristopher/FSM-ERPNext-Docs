...
source_url: https://docs.frappe.io/erpnext/user/manual/en/coupon-code
...
A Coupon Code connects a customer-entered web-store code to a coupon-based [Pricing Rule](https://docs.frappe.io/erpnext/pricing-rule). Use it to offer a controlled discount through a promotional code or a customer-specific gift-card-style code.
...
-   Coupon entry is enabled in [E-commerce Settings](https://docs.frappe.io/erpnext/e-commerce-settings).
-   The eligible [Items](https://docs.frappe.io/erpnext/item) and prices are available online.
...
-   Another automatic [Promotional Scheme](https://docs.frappe.io/erpnext/promotional-scheme) or discount that could overlap.
...
-   [Shopping Cart](https://docs.frappe.io/erpnext/shopping-cart)
