...
source_url: https://docs.frappe.io/erpnext/user/manual/en/document-versioning
...
![Document Versioning](https://docs.frappe.io/files/using-document-versioning-1.png)
...
3.  You shall be directed to the [Customize Form](https://docs.frappe.io/erpnext/customize-form) page for Purchase Order.
4.  Check the field "Track changes" in the Properties.  
    [Document Versioning](https://docs.frappe.io/files/using-document-versioning-2.gif)
...
![Document Versioning](https://docs.frappe.io/files/using-document-versioning-3.gif)
