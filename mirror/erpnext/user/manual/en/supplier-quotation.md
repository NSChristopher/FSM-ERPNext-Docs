...
source_url: https://docs.frappe.io/erpnext/user/manual/en/supplier-quotation
upstream_updated: "27-02-2026 17:26:53"
...
![Buying Flow](https://docs.frappe.io/files/buying_flow_sq.png)
...
![Supplier Quotation from Material Receipt](https://docs.frappe.io/files/supplier-quotation-from-mr.png)

Or:

A Supplier Quotation can be created from a [Supplier master](https://docs.frappe.io/erpnext/supplier).

Or:

The supplier can submit you a quotation himself via ERPNext. To know more about this, see section visit the [Request for Quotation page](https://docs.frappe.io/erpnext/request-for-quotation#4-creating-a-supplier-quotation-after-rfq).
...
3.  Enter the Item code, select the quantity. Rate will be fetched if you've set the Standard Buying rate for the item in [Item Price](https://docs.frappe.io/erpnext/item-price).  
    ![Supplier Quotation](https://docs.frappe.io/files/supplier-quotation.png)

If you have multiple Suppliers who supply you with the same Item, you  
usually send out a [Request for Quotation](https://docs.frappe.io/erpnext/request-for-quotation) to various Suppliers. In  
...
1.  [Supplier](https://docs.frappe.io/erpnext/supplier)
2.  [Supplier Group](https://docs.frappe.io/erpnext/supplier-group)
3.  [Purchase Order](https://docs.frappe.io/erpnext/purchase-order)
4.  [Request for Quotation](https://docs.frappe.io/erpnext/request-for-quotation)
