---
title: "Drop Ship | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/drop-shipping-in-erpnext
upstream_updated: "23-07-2026 23:41:04"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Drop Ship | ERPNext Documentation
...
![Drop-ship Sales Order with the customer, delivery date, supplier-delivered items, quantities, rates, and stock indicators.](https://docs.frappe.io/files/drop-ship-sales-order76e80b.webp)
...
![The highlighted pencil icon opens the complete Sales Order item row.](https://docs.frappe.io/files/drop-ship-item-pencil.webp)
...
![The item row with Supplier delivers to Customer enabled and Apex Devices selected as the Supplier.](https://docs.frappe.io/files/drop-ship-item-fields.webp)

![The Customer and company address information used for the drop-ship transaction.](https://docs.frappe.io/files/drop-ship-customer-address.webp)
