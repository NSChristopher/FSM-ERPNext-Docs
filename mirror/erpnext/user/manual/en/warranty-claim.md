...
source_url: https://docs.frappe.io/erpnext/user/manual/en/warranty-claim
upstream_updated: "28-02-2026 14:13:35"
...
-   [Serial Number](https://docs.frappe.io/erpnext/serial-no)
...
5.  Save. ![Warranty Claim](https://docs.frappe.io/files/warranty-claim.png)
...
![Warranty Serial](https://docs.frappe.io/files/warranty-serial.png)
...
-   **Resolved By:** Set the Email ID of the User who has resolved the Warranty Claim. The email ID is linked with [User](https://docs.frappe.io/erpnext/adding-users) created in the system.
...
![Warranty Resolution](https://docs.frappe.io/files/warranty-resolution.png)

### 3.3 Customer Details

The following details of the [Customer](https://docs.frappe.io/erpnext/customer) will be fetched:
...
![Warranty Customer](https://docs.frappe.io/files/warranty-customer.png)
...
1.  [Issue](https://docs.frappe.io/erpnext/issue)
2.  [Maintenance Visit](https://docs.frappe.io/erpnext/maintenance-visit)
