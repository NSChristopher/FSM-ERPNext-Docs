---
title: "Blanket Order | ERPNext Documentation"
source_url: https://docs.frappe.io/erpnext/user/manual/en/blanket-order
upstream_updated: "29-07-2026 22:56:12"
mirrored_from: docs.frappe.io (Frappe Wiki - not git-backed)
---

# Blanket Order | ERPNext Documentation
...
![Blanket Order with the selling party, validity period, company, committed items, quantities, rates, and ordered quantities.](https://docs.frappe.io/files/blanket-order-overview.webp)
...
![The highlighted pencil icon opens the complete Blanket Order item row.](https://docs.frappe.io/files/blanket-order-item-pencil.webp)
...
![The Blanket Order item row with committed quantity, negotiated rate, ordered quantity, and item-specific terms.](https://docs.frappe.io/files/blanket-order-item-row.webp)
