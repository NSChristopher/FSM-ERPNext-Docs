...
source_url: https://docs.frappe.io/erpnext/user/manual/en/woocommerce_integration
...
![Woocommerce API](https://docs.frappe.io/files/wc-add-key.png)  
3\. Click on "Add key" button. Provide the necessary details and click on "Generate API key" button.

![Woocommerce API Key](https://docs.frappe.io/files/wc-generate-keys.png)
...
![Woocommerce Settings](https://docs.frappe.io/files/woocommerce-settings.png)
...
![Woocommerce Webhook](https://docs.frappe.io/files/wc-webhook.png)

A GIF below to show the entire process:

![Woocommerce Set Up](https://docs.frappe.io/files/woocommerce-setup.gif)
...
![Woocommerce Set Up](https://docs.frappe.io/files/woocommerce-order.gif)
...
![Woocommerce Defaults](https://docs.frappe.io/files/wc-defaults.png)
...
2.  [Item](https://docs.frappe.io/erpnext/item)
3.  [Customer](https://docs.frappe.io/erpnext/customer)
4.  [Address](https://docs.frappe.io/erpnext/address)
