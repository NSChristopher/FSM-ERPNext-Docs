...
source_url: https://docs.frappe.io/erpnext/user/manual/en/auto-creation-of-material-request
...
![reorder level](https://docs.frappe.io/files/reorder-request-1.png)
...
![reorder level next action](https://docs.frappe.io/files/reorder-request-2.png)
...
![active auto-material request](https://docs.frappe.io/files/reorder-request-3.png)
...
One of the reason of error could be Fiscal Year as well. Click [here](https://docs.frappe.io/erpnext/fiscal-year-error.html) to learn more about it.
