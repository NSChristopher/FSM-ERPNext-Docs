...
source_url: https://docs.frappe.io/hr/mobile-app-installation
...
Frappe HR ships with a mobile frontend (progressive web app) v15 onwards. To install the app on your phones, go to https:///hrms eg: if my site name is [https://frappeio.frappe.cloud](https://frappeio.frappe.cloud), the mobile app can be installed from [https://frappeio.frappe.cloud/hrms](https://frappeio.frappe.cloud/hrms)  
